webpackJsonp([5], {
  ...
  1202: function(e, t, n) {
    ...
    var i, r, s;
    Object.defineProperty(t, '__esModule', { value: !0 }), (i = n(2)), (r = n(1203)), (s = n(14)), (t.Dialog = o);
  },
  1203: function(e, t) {
    e.exports = {
  ...
  1204: function(e, t, n) {
    ...
    function i(e) {
      var t,
        n = l.makeTransitionGroupLifecycleProvider(c.makeTransitionGroupLifecycleConsumer(o(e)));
      return (
        (t = (function(e) {
          function t(t) {
            ...
            return (
              ...
              (n._uuid = d.guid()),
              (n._zIndexUpdateEvent = u.EVENTS.ZindexUpdate + ':' + n._uuid),
              n
            );
          }
          return (
            ...
            (t.prototype.render = function() {
              return 'parent' === this.props.root
                ? s.createElement(a.TransitionGroup, { component: 'div' }, this._createContent(this.props))
                : null;
            }),
            ...
            (t.prototype._createContent = function(e) {
              return e.isOpened
                ? (u.OverlapManager.registerWindow(this._uuid),
                  s.createElement(
                    n,
                    r.__assign({}, e, { key: this._uuid, zIndex: u.OverlapManager.getZindex(this._uuid) }),
                    e.children
                  ))
                : (u.OverlapManager.unregisterWindow(this._uuid), null);
            }),
  ...
  1208: function(e, t, n) {
    ...
    function o(e) {
      return i.createElement(
        ...
        e.children,
        i.createElement(a.Icon, { className: r.close, icon: s, onClick: e.onClose })
      );
    }
    var i, r, s, a;
    Object.defineProperty(t, '__esModule', { value: !0 }),
  ...
  1210: function(e, t, n) {
    ...
    var i, r;
    Object.defineProperty(t, '__esModule', { value: !0 }), (i = n(2)), (r = n(1211)), (t.Footer = o);
  },
  1211: function(e, t) {
  ...
  1212: function(e, t, n) {
    ...
    var i, r;
    Object.defineProperty(t, '__esModule', { value: !0 }), (i = n(2)), (r = n(1213)), (t.Body = o);
  },
  1213: function(e, t) {
    ...
    function o(e) {
      ...
      return (
        ...
        i.createElement(
          ...
          { transitionName: 'message', transitionEnterTimeout: u.dur, transitionLeaveTimeout: u.dur },
          t
            ? i.createElement(
                'div',
                { className: n, key: '0' },
                i.createElement(a.OutsideEvent, { mouseDown: !0, touchStart: !0, handler: e.onClickOutside }, t)
              )
            : null
        )
      );
            ...
            return i.createElement(
              ...
              i.createElement(
                ...
                o.__assign({}, this.props, {
                  ...
                  className: p(l.dialog, this.props.className),
                }),
                this.props.children
              )
            );
  ...
  1283: function(e, t, n) {
    ...
    function o(e) {
      ...
      return e.setHtml ? r.createElement('span', { dangerouslySetInnerHTML: { __html: t } }) : t;
    }
    var i, r, s, a, u, l, c, d;
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (i = n(0)),
      ...
      (d = (function(e) {
        ...
        return (
          ...
          (t.prototype.render = function() {
            return r.createElement(
              s.PopupDialog,
              { className: u.popupDialog, isOpened: this.props.isOpened, onClickOutside: this.props.onClose },
              r.createElement(a.Header, { onClose: this.props.onClose }, window.t('Symbol Info')),
              r.createElement(
                a.Body,
                null,
                r.createElement(c.KeyboardDocumentListener, { keyCode: 27, handler: this.props.onClose }),
                r.createElement('div', { className: u.content }, this._renderFields())
              )
            );
          }),
            ...
            return this.props.fields
              ? this.props.fields.map(function(e) {
                  return r.createElement(
                    ...
                    r.createElement(
                      'div',
                      { className: l(u.column, u.columnTitle) },
                      r.createElement('span', { className: u.title }, e.title)
                    ),
                    r.createElement(
                      'div',
                      { className: l(u.column, u.columnValue) },
                      r.createElement('span', { className: u.value }, o(e))
                    )
                  );
                })
              : [];
  ...
  414: function(e, t, n) {
    ...
    (function(e, o) {
      function i(e, t) {
        var n, i, u, c, d;
        r({ isOpened: !1 }),
          null == e && (e = b.symbol.value()),
          null != e &&
            ((e += ''),
            (n = t && t.symbolInfo),
            (i = [
              { title: $.t('Symbol Name'), propName: o.enabled('charting_library_base') ? 'name' : 'pro_name' },
              ...
              { title: $.t('Timezone'), propName: 'timezone', formatter: s, optional: !0 },
              { title: $.t('Session'), propName: 'session', formatter: a, optional: !0, setHtml: !0 },
            ]),
            (u = 0),
            n && (u = l(n, i)),
            u < i.length &&
              window.quoteSessionMultiplexerInstance &&
              ((c = 'symbolinfodialog.' + x.guid()),
              quoteSessionMultiplexerInstance.full.subscribe(c, e, function(t, n) {
        ...
        for (n = 0; n < t.length; n++)
          (o = t[n].propName) in e &&
            ...
            'minmove2' === o && e.minmove2 > 0 && !e.fractional && e.pricescale
              ? ((t[n].value = new w(e.pricescale / i).format(i / e.pricescale)), (t[n].title = $.t('Pip Size')))
              : (t[n].value = (t[n].formatter || u)(i)),
            s++);
        return (
          (r =
            (e.type && 'economic' === e.type) ||
            (e.listed_exchange && ['QUANDL', 'BSE_EOD', 'NSE_EOD', 'LSE_EOD'].indexOf(e.listed_exchange) >= 0)),
          r && c(t),
          s
        );
      }
      function c(e) {
        for (var t = 0; t < e.length; t++) e[t].optional && (e.splice(t, 1), t--);
      }
      function d(e) {
        var t, n;
        return e > N.minutesPerDay && (e -= N.minutesPerDay), (t = e % 60), (n = (e - t) / 60), S(n, 2) + ':' + S(t, 2);
      }
      function p(e) {
        return e.reduce(function(e, t) {
          var n = d(t.alignedStart()) + '-' + d(t.alignedStart() + t.length()),
            o = t.dayOfWeek();
          return e.hasOwnProperty(n) ? e[n].push(o) : (e[n] = [o]), e;
        }, {});
      }
      function h(e) {
        return e.match(W)[0];
      ...
      function m(t, n, o) {
        return void 0 === o
          ? e.weekdaysMin(n - 1) + ' ' + t
          : e.weekdaysMin(n - 1) + '-' + e.weekdaysMin(o - 1) + ' ' + t;
      }
      function _(e) {
        return 1 === e ? 7 : e - 1;
      }
                ...
                : ((o = []),
                  i.forEach(function(t, r) {
                    ...
                    s && t === s - 1
                      ...
                      : t !== o[o.length - 1] + 1
                      ? e.push(g(n, t, u))
                      : (o.push(t), v(o, u), e.push(m(n, o[0], o[o.length - 1])), o.splice(0, o.length));
                  })),
              e
            );
          }, [])
