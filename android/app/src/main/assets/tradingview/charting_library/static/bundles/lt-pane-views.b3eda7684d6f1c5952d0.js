webpackJsonp([1], {
  1079: function(e, t, i) {
    ...
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(110).TrendLineRenderer,
      o = i(375),
      l = i(11),
      h = i(53).CompositeRenderer,
      d = i(1236).ArcWedgeRenderer,
      c = i(74).LineEnd;
    inherit(n, s),
      ...
      (n.prototype._updateImpl = function() {
        ...
        if (
          ...
          (this._cacheState = this._source.getCache().updateSource(this._source)),
          (this._levels = []),
          ...
          for (
            e = this._points,
              ...
              this._edge2 = c,
              d < c && ((this._edge1 = Math.max(d, c)), (this._edge2 = Math.min(d, c) + 2 * Math.PI)),
              Math.abs(d - c) > Math.PI &&
                ((this._edge1 = Math.min(d, c)), (this._edge2 = Math.max(d, c) - 2 * Math.PI)),
      ...
      (n.prototype.renderer = function() {
        ...
        if (
          (this._invalidated && (this._updateImpl(), (this._invalidated = !1)), (e = new h()), this._points.length < 2)
        )
          return e;
        if (
        ...
        for (
          ...
          if (
            ...
            if (!(x = this._cacheState.preparedCells.cells[this._levels[v].index - 1])) continue;
            (b = {
              left: x.left,
        ...
        return (
          this.isAnchorsRequired() &&
            ((i = [n, r]),
            this._model.lineBeingCreated() !== this._source && i.push(a),
  ...
  1080: function(e, t, i) {
    ...
    var r = i(371).LineSourcePaneView,
      s = i(110).TrendLineRenderer,
      a = i(1217).TriangleRenderer,
      o = i(166).TextRenderer,
      l = i(53).CompositeRenderer,
      h = i(89).NumericFormatter,
      d = i(74).LineEnd;
    inherit(n, r),
      (n.prototype.renderer = function() {
        ...
        return (
          ...
          this._points.length < 2
            ...
            : ((e = this._source.properties()),
              ...
              this._points.length >= 3 &&
                ((o = this._points[0].add(this._points[2]).scaled(0.5)),
                (h = r(o, this._numericFormatter.format(this._ABRetracement))),
                this._abLabelRenderer.setData(h),
                t.append(this._abLabelRenderer)),
              this._points.length >= 4 &&
                ((o = this._points[1].add(this._points[3]).scaled(0.5)),
                (c = s(this._points[1], this._points[3])),
                this._bcRetracementTrend.setData(c),
                t.append(this._bcRetracementTrend),
                (h = r(o, this._numericFormatter.format(this._BCRetracement))),
                this._bcLabelRenderer.setData(h),
                t.append(this._bcLabelRenderer)),
              this._points.length >= 5 &&
                ((o = this._points[2].add(this._points[4]).scaled(0.5)),
                (h = r(o, this._numericFormatter.format(this._CDRetracement))),
                ...
                (o = this._points[0].add(this._points[4]).scaled(0.5)),
                (h = r(o, this._numericFormatter.format(this._XDRetracement))),
      ...
      (n.prototype.updateImpl = function() {
        ...
        r.prototype._updateImpl.call(this),
          ...
          this._source.points().length >= 4 &&
            ...
            (this._BCRetracement = Math.round(1e3 * Math.abs((n.price - i.price) / (i.price - t.price))) / 1e3)),
          this._source.points().length >= 5 &&
            ((s = this._source.points()[4]),
            (this._CDRetracement = Math.round(1e3 * Math.abs((s.price - n.price) / (n.price - i.price))) / 1e3),
            (this._XDRetracement = Math.round(1e3 * Math.abs((s.price - t.price) / (t.price - e.price))) / 1e3));
      }),
  ...
  1135: function(e, t, i) {
    'use strict';
    function n(e, t) {
      a.call(this, e, t), (this._rendererCache = {}), (this._invalidated = !0), (this._trendLineRenderer = new o());
    }
    var r = i(8).Point,
      s = i(373).RectangleRenderer,
      a = i(371).LineSourcePaneView,
      o = i(110).TrendLineRenderer,
      l = i(375),
      h = i(11),
    ...
    inherit(n, a),
      ...
      (n.prototype._updateImpl = function() {
        ...
        if (
          ...
          (this._cacheState = this._model._fibRetracementLabelsCache.updateSource(this._source)),
          !(this._source.points().length < 2) &&
            ...
            (s = i ? e.price : t.price),
            !this._source.priceScale().isPercent() || null !== (o = this._source.ownerSource().firstValue())))
        )
          for (l = this._source.levelsCount(), h = 1; h <= l; h++)
            (d = 'level' + h),
              ...
              c.visible.value() &&
                ...
                (f = this._source.priceScale().priceToCoordinate(u)),
                this._levels.push({
                  color: _,
                  y: f,
      ...
      (n.prototype.renderer = function() {
        var e, t, i, n, a, p, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C;
        if (
          (this._invalidated && (this._updateImpl(), (this._invalidated = !1)), (e = new d()), this._points.length < 2)
        )
          return e;
        for (
          t = this._points[0],
            ...
            f = p.extendLines.value() ? this._model.timeScale().width() : a,
          ...
          if (
            ...
            if (!(S = this._cacheState.preparedCells.cells[this._levels[w].index - 1])) continue;
            switch (p.horzLabelsAlign.value()) {
              case 'left':
                P = t;
                break;
              case 'center':
                (P = t.add(i).scaled(0.5)), (P.x += S.width / 2), (P.x = Math.round(P.x));
                break;
              case 'right':
                p.extendLines.value()
                  ? (P = new r(f - 4, this._levels[w].y))
                  : ((P = new r(f + 4, this._levels[w].y)), (P.x += S.width), (P.x = Math.round(P.x)));
            }
            (R = {
              left: S.left,
              ...
              (T = { left: P.x - R.width, top: P.y, width: S.width, height: R.height }),
  ...
  1136: function(e, t, i) {
    ...
    var s = i(1219).ParallelChannelRenderer,
      a = i(371).LineSourcePaneView,
      o = i(110).TrendLineRenderer,
      l = i(375),
      h = i(53).CompositeRenderer,
    ...
    inherit(n, s),
      (n.prototype._getColor = function() {
        return d.generateColor(this._data.backcolor, this._data.transparency, !0);
      }),
      inherit(r, a),
      ...
      (r.prototype._updateImpl = function() {
        a.prototype._updateImpl.call(this),
          (this._cacheState = this._model._fibChannelLabelsCache.updateSource(this._source)),
      ...
      (r.prototype.renderer = function() {
        function e(e, n, r) {
          ...
          switch (i.horzLabelsAlign.value()) {
            case 'left':
              ...
              break;
            case 'center':
              (s = e.add(n).scaled(0.5)), (s.x += r.width / 2), (s.x = Math.round(s.x));
              break;
            case 'right':
              (s = n.clone()), (s.x += r.width), (s.x = Math.round(s.x));
          }
          (a = {
            left: r.left,
            ...
            (h = { left: Math.round(s.x - a.width), top: Math.round(s.y), width: r.width, height: a.height }),
        ...
        var t, i, r, s, a, o, d, p, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C;
        if (
          ...
          if (((f = i['level' + u]), f.visible.value())) {
            ...
            (y = this.norm.scaled(f.coeff.value())),
              ...
              (i.showCoeffs.value() || i.showPrices.value()) &&
                ((L = this._cacheState.preparedCells.cells[u - 1]), e(m, x, L));
          }
        ...
        return (
          null != C &&
            ...
            f.visible.value() &&
              ...
              (i.showCoeffs.value() || i.showPrices.value()) && e(m, x, this._cacheState.preparedCells.cells[C - 1]))),
          this.addAnchors(t),
          t
        );
      }),
  ...
  1137: function(e, t, i) {
    ...
    function r(e, t) {
      o.call(this, e, t), (this._rendererCache = {}), (this._invalidated = !0), (this._trendLineRenderer = new l());
    }
    var s = i(8).Point,
      a = i(54),
      o = i(371).LineSourcePaneView,
      l = i(110).TrendLineRenderer,
      h = i(375),
      d = i(11),
    ...
    (n.prototype.draw = function(e) {
      (e.lineCap = 'butt'),
        ...
        this._data.fillBackground &&
          ...
          (e.fillStyle = p.generateColor(this._data.color, this._data.transparency, !0)),
          e.fill());
    }),
      (n.prototype.hitTest = function(e) {
        var t, i, n;
        return a.sign(e.y - this._data.center.y) === this._data.dir || this._data.fullCircles
          ? ((t = e.subtract(this._data.center)),
            (i = t.length()),
            (n = 3),
            Math.abs(i - this._data.radius) < n
              ? this._hittest
              : this._data.hittestOnBackground && Math.abs(i) <= this._data.radius + n
              ? this._backHittest
              : null)
          : null;
      }),
      ...
      (r.prototype._updateImpl = function() {
        ...
        if (
          ...
          (this._cacheState = this._model._fibSpeedResistanceArcsLabelsCache.updateSource(this._source)),
          !(this._floatPoints.length < 2) &&
            this._source.priceScale() &&
            !this._source.priceScale().isEmpty() &&
            !this._model.timeScale().isEmpty())
      ...
      (r.prototype.renderer = function() {
        ...
        for (
          ...
          if (
            ...
            if (!(g = this._cacheState.preparedCells.cells[this._levels[l].index - 1])) continue;
            (v = {
              left: g.left,
  ...
  1138: function(e, t, i) {
    ...
    var r = i(1236).ArcWedgeRenderer,
      s = i(1079).FibWedgePaneView,
      a = i(110).TrendLineRenderer,
      o = i(53).CompositeRenderer,
      l = i(74).LineEnd;
    inherit(n, s),
      (n.prototype.update = function() {
  ...
  1139: function(e, t, i) {
    ...
    inherit(n, s),
      ...
      (n.prototype._updateImpl = function() {
        ...
        if (
          (s.prototype._updateImpl.call(this),
          (this._cacheState = this._model._trendBasedFibExtensionLabelsCache.updateSource(this._source)),
          !(this._source.points().length < 3) &&
            this._source.priceScale() &&
            !this._source.priceScale().isEmpty() &&
            !this._model.timeScale().isEmpty())
          ...
          for (
            e = this._source.points()[0],
              ...
              r.reverse && r.reverse.value() && (n = r.reverse.value()),
              this._levels = [],
              a = n ? e.price - t.price : t.price - e.price,
              this._source.priceScale().isPercent() && (o = this._source.ownerSource().firstValue()),
      ...
      (n.prototype.renderer = function() {
        var e, t, i, n, s, p, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C, k, I;
        if (
          (this._invalidated && (this._updateImpl(), (this._invalidated = !1)), (e = new d()), this._points.length < 2)
        )
          return e;
        ...
        for (
          p = this._points[2],
            ...
            v = n.extendLines.value() ? this._model.timeScale().width() : u,
          ...
          if (
            ...
            (P = new o()),
            P.setData(s),
            P.setHitTest(new h(h.MOVEPOINT, null, this._levels[m].index)),
            e.append(P),
            n.showCoeffs.value() || n.showPrices.value())
          ) {
            if (!(R = this._cacheState.preparedCells.cells[this._levels[m].index - 1])) continue;
            switch (n.horzLabelsAlign.value()) {
              case 'left':
                T = t;
                break;
              case 'center':
                (T = t.add(i).scaled(0.5)), (T.x += R.width / 2), (T.x = Math.round(T.x));
                break;
              case 'right':
                n.extendLines.value()
                  ? (T = new r(v - 4, this._levels[m].y))
                  : ((T = new r(v + 4, this._levels[m].y)), (T.x += R.width), (T.x = Math.round(T.x)));
            }
            (L = {
              left: R.left,
              ...
              (C = { left: T.x - L.width, top: T.y, width: R.width, height: L.height }),
  ...
  1140: function(e, t, i) {
    ...
    var r = i(8).Point,
      ...
      l = i(11),
      h = i(53).CompositeRenderer,
      d = i(89).NumericFormatter,
      c = i(1237).EllipseRendererSimple,
      p = i(74).LineEnd;
    inherit(n, s),
      (n.prototype.update = function() {
        this._invalidated = !0;
      ...
      (n.prototype._updateImpl = function() {
        ...
        if (
          (s.prototype._updateImpl.call(this),
          (this._cacheState = this._model._fibCirclesLabelsCache.updateSource(this._source)),
          !(this._source.points().length < 2) &&
            this._source.priceScale() &&
            !this._source.priceScale().isEmpty() &&
            !this._model.timeScale().isEmpty())
          ...
          for (
            ...
            (h = 'level' + l),
              ...
              d.visible.value() &&
                ...
                (p = d.color.value()),
                (_ = []),
                _.push(new r(this._center.x - 0.5 * i * c, this._center.y - 0.5 * n * c)),
                _.push(new r(this._center.x + 0.5 * i * c, this._center.y + 0.5 * n * c)),
                (u = new r(this._center.x, this._center.y + 0.5 * n * c)),
                this._levels.push({
                  color: p,
                  points: _,
                  labelPoint: u,
      ...
      (n.prototype.renderer = function() {
        ...
        for (
          ...
          if (
            ...
            if (!(f = this._cacheState.preparedCells.cells[this._levels[a].index - 1])) continue;
            (g = {
              left: f.left,
  ...
  1141: function(e, t, i) {
    'use strict';
    function n(e, t) {
      s.call(this, e, t), (this._invalidated = !0), (this._lineRenderer = new l());
    }
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(1199).PaneRendererClockIcon,
      o = i(53).CompositeRenderer,
      l = i(376).VerticalLineRenderer;
    inherit(n, s),
      (n.prototype.update = function() {
        this._invalidated = !0;
      }),
      ...
      (n.prototype.renderer = function() {
        ...
        return (
          ...
          TradingView.printing ||
            ...
            1 !== e.points.length ||
            ((i = new r(this._points[0].x, this._source.priceScale().height() / 2)),
            this._source.getAlertIsActive(function(n) {
              t.append(
                new a({
                  point1: i,
                  color: n ? e.color : defaults('chartproperties.alertsProperties.drawingIcon.color'),
                })
              );
            })),
          t
  ...
  1142: function(e, t, i) {
    ...
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(376).VerticalLineRenderer,
      o = i(373).RectangleRenderer,
      l = i(110).TrendLineRenderer,
      h = i(11),
      d = i(176).PaneRendererLine,
      c = i(53).CompositeRenderer,
      p = i(30),
      _ = i(245).LineToolBarsPatternMode,
      u = i(74).LineEnd;
    inherit(n, s),
      (n.prototype.renderer = function() {
        var e, t, i, n, s, a, l, f, g, v, w, y, m, x, b, S, P, R, T, L, C, k;
        if (
          (this._invalidated && (this.updateImpl(), (this._invalidated = !1)),
          ...
          if (
            ...
            (s = Math.abs((this._points[0].x - this._points[1].x) / (this._pattern.length - 1))),
            n === _.Bars || n === _.OpenClose)
          ) {
            for (
              a = new c(), l = n === _.Bars ? ['high', 'low'] : ['open', 'close'], f = l[0], g = l[1], v = 0;
              ...
              (w = Math.round(i.x + v * s + 0.5)),
                ...
                b.setData(x),
                a.append(b);
            return this.isAnchorsRequired() && a.append(this.createLineAnchor({ points: this._points })), a;
          }
          return (
            (a = new c()),
            (x = {}),
            ...
            (x.histogramBase = 0),
            (x.lineIndex = 0),
            (x.lineColor = p.generateColor(this._source.properties().color.value(), 10)),
            (x.lineStyle = CanvasEx.LINESTYLE_SOLID),
            (x.lineWidth = 2),
            (x.hittest = new h(h.MOVEPOINT)),
            a.append(new d(x)),
            this.isAnchorsRequired() && a.append(this.createLineAnchor({ points: this._points })),
            a
          );
        }
        return (
      ...
      (n.prototype.updateImpl = function() {
        ...
        !this._source.priceScale() ||
          this._source.priceScale().isEmpty() ||
          this._points.length < 2 ||
          (this._source._pattern && this._source._pattern.length > 0 && 2 === this._source.points().length
            ? ((e = this._source.priceScale()),
              ...
              (s = e.priceRange()),
              e.isPercent()
                ? ((o = s.convertToPercent(t, n)), (a = e.priceToCoordinate(o)))
                : (a = e.priceToCoordinate(t)),
              (l = function(r) {
                var o = (r - t) * i + t;
                return e.isPercent() && (o = s.convertToPercent(o, n)), e.priceToCoordinate(o) - a;
              }),
              (h = parseInt(this._source.properties().mode.value())),
              (d = this._source.points()[0].index),
              (c = this._source.points()[1].index),
              (p = d > c ? 1 : 0),
              (_ = this._points[p]),
              (u = _.x),
              (f = Math.abs((this._points[0].x - this._points[1].x) / (this._source._pattern.length - 1))),
              (g = {
                0: function(e) {
                  return { high: l(e[TradingView.HIGH_PLOT]), low: l(e[TradingView.LOW_PLOT]) };
                },
                1: function(e, t) {
                  return new r(u + t * f, l(e[TradingView.CLOSE_PLOT]) + _.y);
                },
                2: function(e) {
                  return { open: l(e[TradingView.OPEN_PLOT]), close: l(e[TradingView.CLOSE_PLOT]) };
                },
                3: function(e, t) {
                  return new r(u + t * f, l(e[TradingView.OPEN_PLOT]) + _.y);
                },
                4: function(e, t) {
                  return new r(u + t * f, l(e[TradingView.HIGH_PLOT]) + _.y);
                },
                5: function(e, t) {
                  return new r(u + t * f, l(e[TradingView.LOW_PLOT]) + _.y);
                },
                6: function(e, t) {
                  return new r(u + t * f, l((e[TradingView.HIGH_PLOT] + e[TradingView.LOW_PLOT]) / 2) + _.y);
                },
              }),
  ...
  1143: function(e, t, i) {
    ...
    var r = i(8).Point,
      s = i(376).VerticalLineRenderer,
      a = i(371).LineSourcePaneView,
      o = i(166).TextRenderer,
      l = i(373).RectangleRenderer,
          ...
          for (o = 1; o <= 11; o++)
            (l = 'level' + o),
              ...
              h.visible.value() &&
                ...
                (c = h.color.value()),
                (p = Math.round(s + d * n)),
                (_ = this._model.timeScale().indexToCoordinate(p)),
                (u = {
                  x: _,
                  coeff: d,
                  color: c,
                ...
                r.showCoeffs.value() && ((u.text = d), (u.y = this._source.priceScale().height())),
                this._levels.push(u));
      }),
      (n.prototype.renderer = function() {
        var e, t, i, n, a, h, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L;
        if (
          (this._invalidated && (this.updateImpl(), (this._invalidated = !1)), (e = new c()), this._points.length < 2)
        )
          return e;
        if (
          ((t = this._points[0]),
        ...
        for (
          ...
          if (
            (v > 0 &&
              ...
              ((w = this._levels[v - 1]),
              (t = new r(w.x, 0)),
              (i = new r(this._levels[v].x, this._source.priceScale().height())),
              (y = {}),
              (y.points = [t, i]),
            ...
            switch (
              ((P = n.horzLabelsAlign.value()), (P = 'left' === P ? 'right' : 'right' === P ? 'left' : 'center'))
            ) {
              case 'left':
                b = 3;
                break;
            ...
            switch (n.vertLabelsAlign.value()) {
              case 'top':
                ...
                break;
              case 'middle':
                (x = new r(this._levels[v].x, 0.5 * this._levels[v].y)), (S = 0);
                break;
              case 'bottom':
                (x = new r(this._levels[v].x, this._levels[v].y)), (S = -10);
            }
            (R = {
              points: [x],
  ...
  1144: function(e, t, i) {
    'use strict';
    function n(e, t) {
      s.call(this, e, t), (this._levels = []), (this._invalidated = !0), (this._trendRenderer = new h());
    }
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(376).VerticalLineRenderer,
      ...
      (n.prototype.updateImpl = function() {
        ...
        if (
          ...
          !(this._source.points().length < 1) &&
            ...
            !this._model.timeScale().isEmpty() &&
            ((e = this._source.points()[0]),
            2 === this._source.points().length && (t = this._source.points()[1]),
            (i = this._source.properties()),
            (n = this._source.points()[0].index),
            null !== this._model.timeScale().visibleBars()))
        )
          for (this._levels = [], r = t ? t.index - e.index : 1, a = 1; a <= 11; a++)
            (o = i['level' + a]),
              o.visible.value() &&
                ...
                i.showLabels.value() && ((d.text = o.coeff.value()), (d.y = this._source.priceScale().height())),
                this._levels.push(d));
      }),
      (n.prototype.renderer = function() {
        ...
        for (
          ...
          if (
            ...
            s > 0 &&
              ...
              (v = new r(f.x, this._source.priceScale().height())),
              (w = {}),
              (w.points = [g, v]),
            ...
            switch (
              ((b = n.horzLabelsAlign.value()), (b = 'left' === b ? 'right' : 'right' === b ? 'left' : 'center'))
            ) {
              case 'left':
                m = 3;
                break;
            ...
            switch (n.vertLabelsAlign.value()) {
              case 'top':
                ...
                break;
              case 'middle':
                (y = new r(this._levels[s].x, 0.5 * this._levels[s].y)), (x = 0);
                break;
              case 'bottom':
                (y = new r(this._levels[s].x, this._levels[s].y)), (x = -10);
            }
            (S = {
              points: [y],
  ...
  1145: function(e, t, i) {
    'use strict';
    function n(e, t) {
      s.call(this, e, t), (this._lines = []), (this._invalidated = !0), (this._trendRenderer = new o());
    }
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(376).VerticalLineRenderer,
      ...
      (n.prototype.updateImpl = function() {
        ...
        if (
          ...
          if (((r = e.visibleBars()), n > 0))
            for (a = t.index, o = a; o <= r.lastBar(); o += n) this._lines.push({ x: e.indexToCoordinate(o) });
          else for (a = t.index, o = a; o >= r.firstBar(); o += n) this._lines.push({ x: e.indexToCoordinate(o) });
      }),
      (n.prototype.renderer = function() {
        var e, t, i, n, s, o, c, p, _, u, f;
        if (
          (this._invalidated && (this.updateImpl(), (this._invalidated = !1)), (e = new h()), this._points.length < 2)
        )
          return e;
        for (
          t = this._points[0],
        ...
        return (
          this.isAnchorsRequired() &&
            (2 === this._source.points().length
              ? ((f = [].concat(this._points)), e.append(this.createLineAnchor({ points: f })))
              : e.append(
                  this.createLineAnchor({
                    points: [new r(this._points[0].x, this._source.priceScale().height() / 2)],
  ...
  1146: function(e, t, i) {
    ...
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(166).TextRenderer,
      o = i(373).RectangleRenderer,
      l = i(110).TrendLineRenderer,
      h = i(53).CompositeRenderer,
      d = i(379).TimeSpanFormatter,
      c = i(74).LineEnd;
    inherit(n, s),
      (n.prototype.update = function() {
        this._invalidated = !0;
      ...
      (n.prototype.renderer = function(e) {
        var t, i, n, s, a, o, l, p, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C, k, I, B, M;
        return (
          this._invalidated && this.updateImpl(),
          (t = new h()),
            ...
            : ((i = this._source.properties()),
              ...
              (f = function(e, i, n) {
                ...
                (r.points = [i, n]),
                  ...
                  (r.color = u._source.properties().linecolor.value()),
                  (r.linewidth = u._source.properties().linewidth.value()),
              ...
              f(this._leftBorderRenderer, new r(a.x, l), new r(a.x, p)),
              f(this._rightBorderRenderer, new r(o.x, l), new r(o.x, p)),
              (g = (a.y + o.y) / 2),
              (v = new r(a.x, g)),
              (w = new r(o.x, g)),
              (_ = {}),
              ...
              (_.linewidth = u._source.properties().linewidth.value()),
              ...
              (P = ''),
              b && S && ((R = (S.valueOf() - b.valueOf()) / 1e3), (P = ', ' + new d().format(R))),
              ...
              i.fillLabelBackground &&
                ...
                (_.backgroundTransparency = 1 - i.labelBackgroundTransparency.value() / 100 || 0)),
              i.drawBorder && i.drawBorder.value() && (_.borderColor = i.borderColor.value()),
              (C = 0.5 * (a.x + o.x)),
              (k = o.y),
              (I = new r(C, k)),
              ...
              (M = {
                x: C + _.backgroundHorzInflate + B.textBgPadding - B.width / B.textBgPadding,
                y:
                  a.y > o.y
  ...
  1147: function(e, t, i) {
    ...
    var r = i(8).Point,
      ...
      l = i(110).TrendLineRenderer,
      h = i(53).CompositeRenderer,
      d = i(167).PercentageFormatter,
      c = i(377).PipFormatter,
      p = i(74).LineEnd;
    inherit(n, s),
      (n.prototype.update = function() {
        this._invalidated = !0;
      ...
      (n.prototype.renderer = function() {
        var e, t, i, n, s, a, o, l, d, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C, k, I, B;
        return (
          this._invalidated && (this.updateImpl(), (this._invalidated = !1)),
          (e = new h()),
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this._source.properties()),
              ...
              f(this._topBorderRenderer, new r(l, a.y), new r(d, a.y)),
              f(this._bottomBorderRenderer, new r(l, o.y), new r(d, o.y)),
              (a = this._points[0]),
              (o = this._points[1]),
              (g = (a.x + o.x) / 2),
              (v = new r(g, a.y)),
              ...
              (_ = {}),
              m > y
                ? ((R = o.clone()), (R.y -= 2 * t.fontsize.value()), (R.x = 0.5 * (a.x + o.x)), (_.points = [R]))
                : ((R = o.clone()), (R.x = 0.5 * (a.x + o.x)), (R.y += 0.7 * t.fontsize.value()), (_.points = [R])),
              (T = { x: 0, y: 10 }),
              (_.text = P),
              ...
              t.fillLabelBackground &&
                ...
                (_.backgroundTransparency = 1 - t.labelBackgroundTransparency.value() / 100 || 0)),
              t.drawBorder && t.drawBorder.value() && (_.borderColor = t.borderColor.value()),
              (L = 0.5 * (a.x + o.x)),
              (C = o.y),
              (k = new r(L, C)),
              ...
              (B = {
                x: L + _.backgroundHorzInflate + I.textBgPadding - I.width / I.textBgPadding,
                y:
                  a.y > o.y
                    ? k.y - I.height - 2 * I.textBgPadding - T.y > 0
                      ? C - I.height - T.y - 2 * I.textBgPadding
                      : T.y - 2 * I.textBgPadding
                    : k.y + I.height + I.textBgPadding + T.y > _.height
  ...
  1148: function(e, t, i) {
    ...
    var r = i(8).Point,
      ...
      h = i(53).CompositeRenderer,
      d = i(167).PercentageFormatter,
      c = i(379).TimeSpanFormatter,
      p = i(377).PipFormatter,
      _ = i(74).LineEnd;
    inherit(n, s),
      (n.prototype.update = function() {
        this._invalidated = !0;
      ...
      (n.prototype.renderer = function() {
        var e, t, i, n, s, a, o, l, d, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C, k, I, B, M, A, D, E;
        return (
          this._invalidated && this.updateImpl(),
          (e = new h()),
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this._source.properties()),
              ...
              (s = function(t, i, r) {
                ...
                (s.points = [i, r]),
                  ...
                  (s.color = n._source.properties().linecolor.value()),
                  (s.linewidth = n._source.properties().linewidth.value()),
              ...
              (R = ''),
              S && P && ((T = (P.valueOf() - S.valueOf()) / 1e3), (R = ', ' + new c().format(T))),
              (L = this._model.mainSeries().symbolInfo()),
              L &&
                L !== this._lastSymbolInfo &&
                ((this._pipFormatter = new p(L.pricescale, L.minmov, L.type, L.minmove2)), (this._lastSymbolInfo = L)),
              (C =
                this._source
                  .priceScale()
                  .formatter()
                  .format(w) +
                ' (' +
                this._percentageFormatter.format(Math.round(100 * y) / 100) +
                ') ' +
                (this._pipFormatter ? this._pipFormatter.format(w) : '') +
                '\n' +
                $.t('{0} bars').format(b) +
                R),
              (i = {}),
              v > g
                ? ((k = o.clone()), (k.y -= 2 * t.fontsize.value()), (k.x = 0.5 * (a.x + o.x)), (i.points = [k]))
                : ((k = o.clone()), (k.x = 0.5 * (a.x + o.x)), (k.y += 0.7 * t.fontsize.value()), (i.points = [k])),
              (I = { x: 0, y: 10 }),
              (i.text = C),
              ...
              t.fillLabelBackground &&
                ...
                (i.backgroundTransparency = 1 - t.labelBackgroundTransparency.value() / 100 || 0)),
              t.drawBorder && t.drawBorder.value() && (i.borderColor = t.borderColor.value()),
              (B = 0.5 * (a.x + o.x)),
              (M = o.y),
              (A = new r(B, M)),
              ...
              (E = {
                x: B + i.backgroundHorzInflate + D.textBgPadding - D.width / D.textBgPadding,
                y:
                  a.y > o.y
                    ? A.y - D.height - 2 * D.textBgPadding - I.y > 0
                      ? M - D.height - I.y + D.textBgPadding
                      : I.y - 2 * D.textBgPadding
                    : A.y + D.height + D.textBgPadding + I.y > i.height
  ...
  1149: function(e, t, i) {
    'use strict';
    function n(e, t) {
      r.call(this, e, t), (this._invalidated = !0), (this._renderer = new s()), (this._p3 = null), (this._p4 = null);
    }
    var r = i(371).LineSourcePaneView,
      s = i(1219).ParallelChannelRenderer,
      a = i(1199).PaneRendererClockIcon,
      o = i(53).CompositeRenderer;
    inherit(n, r),
      (n.prototype.update = function() {
            ...
            3 === this._points.length &&
              ...
              s.isLog()
                ? ((a = 0.5 * (i + n) - this._source._priceOffset),
                  (o = 0.5 * (i + n)),
                  (l = this._source.priceScale().priceToCoordinate(a)),
                  (h = this._source.priceScale().priceToCoordinate(o)),
                  (d = h - l),
                  (this._p3.y += d),
                  (this._p4.y += d))
                : (s.isPercent() &&
                    ((c = this._source.ownerSource().firstValue()),
                    (i = s.priceRange().convertToPercent(i, c)),
                    (n = s.priceRange().convertToPercent(n, c))),
                  (this._p3.y = this._source.priceScale().priceToCoordinate(i)),
                  (this._p4.y = this._source.priceScale().priceToCoordinate(n)))));
      }),
      (n.prototype.renderer = function() {
        var e, t, i, n, r, s;
        return (
          ...
          (e = {}),
          (e.points = []),
          this._points.length > 1 && (e.points.push(this._points[0]), e.points.push(this._points[1])),
          this._points.length > 2 &&
            null !== this._p3 &&
            null !== this._p4 &&
          ...
          this.isAnchorsRequired() &&
            ...
            this._p3 && (n.push(this._p3.add(this._p4).scaled(0.5)), (n[n.length - 1].data = n.length - 1)),
            (r = 3 === this._points.length && !this._p3),
            this._model.lineBeingCreated() !== this._source || r || n.pop(),
            ...
            this._source.getAlertIsActive(function(e) {
              i.append(
                new a({
                  point1: s[0],
                  point2: s[1],
                  color: e ? t.linecolor.value() : defaults('chartproperties.alertsProperties.drawingIcon.color'),
                })
              );
            })),
          i
  ...
  1150: function(e, t, i) {
    ...
    var s = i(8).Point,
      a = i(371).LineSourcePaneView,
      o = i(405).TrendLineStatsRenderer,
      l = i(166).TextRenderer,
      h = i(110).TrendLineRenderer,
      d = i(53).CompositeRenderer,
      c = i(167).PercentageFormatter,
      p = i(131).SelectionRenderer,
      _ = i(377).PipFormatter,
      u = i(74).LineEnd,
      f = i(386).LabelSettings,
      g = i(1199).PaneRendererClockIcon;
          ...
          this._source.points().length < 2 ||
            ...
            this._source.properties().showPriceRange.value() &&
              ...
              u &&
                ...
                ((this._pipFormatter = new _(u.pricescale, u.minmov, u.type, u.minmove2)), (this._lastSymbolInfo = u)),
              (l += this._pipFormatter ? ', ' + this._pipFormatter.format(d) : ''),
              o.push('priceRange')),
            (f = this._source.properties().showBarsRange.value()),
            f && ((h = ''), (g = r.index - e.index), (h += $.t('{0} bars').format(g)), o.push('barsRange')),
            (this._label =
              [l, h]
                .filter(function(e) {
                  return e;
        ...
        return (
          ...
          this._secondPoint &&
            ...
            n &&
              ...
              (a = f.offset),
              this._points[1].y < this._points[0].y ? ((s.vertAlign = 'bottom'), (s.offsetY = -a)) : (s.offsetY = a),
              this._points[1].x < this._points[0].x ? ((s.horzAlign = 'right'), (s.offsetX = -a)) : (s.offsetX = a),
              e.append(new o(s, this._rendererCache))),
            r && this._middlePoint && e.append(new p({ points: [this._middlePoint] })),
            (l = {}),
            ...
            this._source.getAlertIsActive(function(i) {
              e.append(
                new g({
                  point1: t.points[0],
                  point2: t.points[1],
                  color: i ? t.color : defaults('chartproperties.alertsProperties.drawingIcon.color'),
                })
              );
            }),
          this._secondPoint &&
            this._points.length > 0 &&
            i &&
            e.append(this.createLineAnchor({ points: [this._points[0], this._secondPoint] })),
          e
        );
      }),
  ...
  1151: function(e, t, i) {
    ...
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(375),
      o = i(1199).PaneRendererClockIcon,
      l = i(53).CompositeRenderer,
      h = i(167).PercentageFormatter,
      d = i(89).NumericFormatter,
      c = i(379).TimeSpanFormatter,
      p = i(377).PipFormatter,
      _ = i(131).SelectionRenderer,
      u = i(110).TrendLineRenderer,
      f = i(386).LabelSettings;
    inherit(n, s),
      (n.prototype.update = function() {
      ...
      (n.prototype.updateImpl = function() {
        ...
        c.length < 2 ||
          ...
          null !== (i = this._model.timeScale().visibleBars()) &&
            ((n = this._source.properties()),
            (e.index < i.firstBar() && t.index < i.firstBar() && !n.extendLeft.value() && !n.extendRight.value()) ||
              (s.prototype._updateImpl.call(this),
              this._points.length < 2 ||
                ...
                l || r || a || o || h
                  ? ((d = this),
                    (this._statCache = this._model._trendLineStatsCache.updateSource(this._source, function() {
                      return d._statLabelData();
                    })))
                  : (this._model._trendLineStatsCache.removeSource(this._source.id()),
                    (this._label = null),
                    this._labelData && ((this._labelData.text = ''), (this._labelData.lines = []))),
                (this._invalidated = !1)))));
      }),
      (n.prototype._statLabelData = function() {
        var e, t, i, n, s, a, o, l, h, d, _, u, g, v, w, y, m, x, b, S, P, R, T, L, C, k, I;
        return (
          this._labelDataInvalidated &&
            ...
            _ &&
              ...
              g &&
                ...
                ((this._pipFormatter = new p(g.pricescale, g.minmov, g.type, g.minmove2)), (this._lastSymbolInfo = g)),
              (a += this._pipFormatter ? ', ' + this._pipFormatter.format(h) : ''),
              s.push('priceRange')),
            ...
            (v || w || y) &&
              ((o = ''),
              v && ((d = i.index - t.index), (o += $.t('{0} bars').format(d))),
              w &&
                ((m = this._model.timeScale().indexToUserTime(t.index)),
                (x = this._model.timeScale().indexToUserTime(i.index)),
                m &&
                  x &&
                  ((b = (x.valueOf() - m.valueOf()) / 1e3), (S = new c().format(b)) && (o += v ? ' (' + S + ')' : S))),
              y &&
                (o && (o += ', '),
                void 0 === h && (h = i.price - t.price),
                void 0 === d && (d = i.index - t.index),
                (P = Math.round(1e5 * Math.sqrt(h * h + d * d)) / 1e5),
                (o += $.t('distance: {0}').format(this._numericFormatter.format(P)))),
              o && s.push('barsRange')),
            (R = n.showAngle.value()),
            R &&
              ((T = this._source.pointToScreenPoint(t)),
              (L = this._source.pointToScreenPoint(i)),
              (T = T instanceof Array ? T[0] : T instanceof r ? T : null),
              (L = L instanceof Array ? L[0] : L instanceof r ? L : null),
              T instanceof r &&
                L instanceof r &&
                ((k = L.subtract(T)),
                k.length() > 0 && ((k = k.normalized()), (C = Math.acos(k.x)), k.y > 0 && (C = -C))),
              'number' != typeof C ||
                TradingView.isNaN(C) ||
                ((l = Math.round((180 * C) / Math.PI) + 'º'), s.push('angle'))),
            (this._label =
              [a, o, l]
                .filter(function(e) {
                  return e;
          ...
          this._points[1].y < this._points[0].y && (I.vertAlign = 'bottom'),
          this._points[1].x < this._points[0].x && (I.horzAlign = 'right'),
          (this._labelData = I),
          I
        );
      }),
          ...
          this._invalidated
            ...
            ? ((t = {}),
              ...
              n &&
                ...
                (d = { left: s.x, top: s.y, width: h.width, height: h.height }),
                'right' === this._labelData.horzAlign ? (d.left -= f.padding + d.width) : (d.left += f.padding),
                'bottom' === this._labelData.vertAlign ? (d.top -= f.padding + d.height) : (d.top += f.padding),
                (c = this._model._trendLineStatsCache.canvas()),
                (p = new a(c.get(0), h, d)),
                e.append(p)),
              r && this._middlePoint && e.append(new _({ points: [this._middlePoint] })),
              this.addAnchors(e),
              !TradingView.printing &&
                this._source.hasAlert.value() &&
                !this._model.readOnly() &&
  ...
  1152: function(e, t, i) {
    ...
    (n.prototype._textWidth = function(e) {
      ...
      (n.prototype.hitTest = function(e) {
        ...
        return (
          'buy' === this._adapter.getDirection() ? ((t = s), (i = s + a)) : ((t = s - a), (i = s)),
          e.x >= r - 2 && e.x <= r + 2 && e.y >= t && e.y <= i
            ? ((n = this._adapter.getTooltip()),
              new l(l.CUSTOM, {
                ...
                tooltip: '' !== n ? { text: n, rect: { x: r, y: t, w: 2, h: i - t } } : null,
              }))
            : null
        );
      }),
            ...
            : ((this._rendererCached = !0),
              ...
              0 === i.length
                ...
                : ((r = t._adapter),
                  ...
                  (o = this._source._model.paneForSource(this._source).executionsPositionController()),
                  (l = o.getXYCoordinate(r, a, i[0].index)),
                  !isFinite(l.y) || l.y < 0 || l.y > e || l.x < 0
                    ? ((this._renderer = null), null)
                    : ((h = [new s(l.x, l.y)]), (d = { points: h }), (this._renderer = new n(d, r)), this._renderer)))
        );
      }),
  ...
  1153: function(e, t, i) {
    'use strict';
    function n(e, t) {
      r.call(this, e, t), (this._invalidated = !0), (this._medianRenderer = new a()), (this._sideRenderer = new a());
    }
    var r = i(371).LineSourcePaneView,
      s = i(1216).ChannelRenderer,
      a = i(110).TrendLineRenderer,
      o = i(11),
      l = i(53).CompositeRenderer,
      h = i(74).LineEnd;
      ...
      (n.prototype.renderer = function() {
        ...
        for (
          i = {
            ...
            n = 0,
            r = this._floatPoints[2].subtract(this._floatPoints[1]).scaled(0.5),
          ...
          (_ = 'level' + p),
            ...
            u.visible.value() &&
              ((f = this._medianPoint.addScaled(r, u.coeff.value())),
              (g = this._medianPoint.addScaled(r, -u.coeff.value())),
              d &&
                ((v = {}),
  ...
  1154: function(e, t, i) {
    'use strict';
    function n(e, t) {
      s.call(this, e, t), (this._numericFormatter = new d()), (this._invalidated = !0);
    }
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(166).TextRenderer,
    ...
    inherit(n, s),
      (n.prototype.renderer = function() {
        function e(e, t, i) {
          function n(t) {
            var i = new l();
            i.setData(Object.assign({}, R, { points: t })), e.append(i);
          }
          var a,
            o,
            h,
        ...
        var t, i, n, s, d, p, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C, k;
        if (
          (this._invalidated && (this.updateImpl(), (this._invalidated = !1)), (t = new h()), this._points.length < 2)
        )
          return this.addAnchors(t), t;
        for (
          i = this._points[0],
        ...
        for (y = 0; y < this._vlevels.length; y++)
          (i = new r(this._vlevels[y].x, d)),
            ...
            u.showBottomLabels.value() &&
              ...
              t.append(new a(C)));
        return (k = this), e(t, this._hfans, !0), e(t, this._vfans, !1), this.addAnchors(t), t;
      }),
      (n.prototype.update = function() {
        this._invalidated = !0;
      }),
          ...
          for (
            ...
            (h = 'hlevel' + l),
              ...
              d.visible.value() &&
                ...
                (u = this._source.priceScale().priceToCoordinate(_)),
                this._hlevels.push({ coeff: c, color: p, y: u }));
          for (
            this._vlevels = [], f = n ? e.index - t.index : t.index - e.index, g = n ? t.index : e.index, l = 1;
            l <= 7;
            l++
          )
            (h = 'vlevel' + l),
          ...
          if (((this._hfans = []), (this._vfans = []), i.fans.visible.value()))
            for (l = 1; l <= 7; l++)
              (v = Math.round(g + i['hlevel' + l].coeff.value() * f)),
                ...
                this._vfans.push(this._source.priceScale().priceToCoordinate(_));
        }
      }),
  ...
  1155: function(e, t, i) {
    'use strict';
    function n(e, t) {
      s.call(this, e, t), (this._numericFormatter = new c()), (this._invalidated = !0);
    }
    var r = i(8).Point,
      s = i(371).LineSourcePaneView,
      a = i(1216).ChannelRenderer,
      o = i(166).TextRenderer,
      l = i(110).TrendLineRenderer,
      h = i(11),
      d = i(53).CompositeRenderer,
      c = i(89).NumericFormatter,
      p = i(74).LineEnd;
    inherit(n, s),
      (n.prototype.update = function() {
        this._invalidated = !0;
        ...
        if (
          ...
          for (
            e = this._source.points()[0],
              ...
              this._hlevels = [],
              i = t.price - e.price,
              this._source.priceScale().isPercent() && (n = this._source.ownerSource().firstValue()),
              r = 1;
            r <= 7;
            r++
          )
            (a = 'hlevel' + r),
              ...
              o.visible.value() &&
                ...
                (c = this._source.priceScale().priceToCoordinate(d, !0)),
      ...
      (n.prototype.renderer = function() {
        var e, t, i, n, s, c, _, u, f, g, v, w, y, m, x, b, S, P, R, T, L, C, k, I;
        if (
          (this._invalidated && (this.updateImpl(), (this._invalidated = !1)),
          (e = new d()),
          this._floatPoints.length < 2)
        ...
        for (
          ...
          (L = new r(i.x, this._hlevels[w].y)),
            ...
            (m = new l()),
            m.setData(y),
            m.setHitTest(new h(h.MOVEPOINT, null, { type: 'h', index: this._hlevels[w].index })),
            e.append(m);
        for (w = 0; w < this._vlevels.length; w++)
          (I = new r(this._vlevels[w].x, i.y)),
            ...
            (m = new l()),
            m.setData(y),
            m.setHitTest(new h(h.MOVEPOINT, null, { type: 'v', index: this._vlevels[w].index })),
            e.append(m);
        return this.addAnchors(e), e;
      }),
      ...
      (p = (function(e) {
        ...
        return (
          ...
          (t.prototype.renderer = function(e) {
            var t, i, n, r, s, a, o, h, d, c, p, _, u, f, g, v;
            return (
              this._invalidated && (this._updateImpl(), (this._invalidated = !1)),
          ...
          (t.prototype._initRenderers = function() {
            ...
            for (t = n.fanLinesCount(), e = 0; e < t; e++) this._fanRenderers.push(new a.TrendLineRenderer());
            for (i = n.arcsCount(), e = 0; e < i; e++) this._arcRenderers.push(new c.GannArcRenderer());
          }),
            ...
            for (i = 0, n = b; i < n.length; i++)
              (s = n[i]),
                s.visible &&
                  ...
                  (c = this._verticalLevelsRenderers[s.index]),
                  c.setData(l),
                  e.append(c),
                  (p = f.y + a * m),
                  (_ = {
                  ...
                  (u = this._horizontalLevelsRenderers[s.index]),
                  u.setData(_),
                  e.append(u));
          }),
            ...
            for (i = 0, n = S; i < n.length; i++)
              (s = n[i]),
                s.visible &&
                  ...
                  (l = void 0),
                  (c = void 0),
                  a > o ? ((l = v.x), (p = o / a), (c = g.y + p * x)) : ((c = v.y), (p = a / o), (l = g.x + p * m)),
                  (_ = {
          ...
          (t.prototype._prepareLabels = function(e, t) {
            ...
            b &&
              ...
              null !== n &&
                ...
                (o = a.mainSeries()),
                (l = o.priceScale()),
                (h = i.getPercantageDiff()),
                (d = n),
                l.isPercentage() && null !== h && (d = h),
                (c = new r.Point(m.x, x.y)),
                (p = l.formatter()),
                (_ = this._getLabelData(c, p.format(d))),
                (_.horzAlign = s > 0 ? 'right' : 'left'),
                (_.vertAlign = n > 0 ? 'bottom' : 'top'),
                (_.offsetX = s > 0 ? -10 : 10),
                (_.offsetY = n > 0 ? -10 : 10),
                this._priceDiffTextRenderer.setData(_),
                e.append(this._priceDiffTextRenderer),
                (u = new r.Point(x.x, m.y)),
                (f = '' + s),
                (g = this._getLabelData(u, f)),
                (g.horzAlign = s > 0 ? 'left' : 'right'),
                (g.vertAlign = n > 0 ? 'top' : 'bottom'),
                (g.offsetX = s > 0 ? 10 : -10),
                (g.offsetY = n > 0 ? 10 : -10),
                this._indexDiffTextRenderer.setData(g),
                e.append(this._indexDiffTextRenderer),
                null !== (v = i.getScaleRatio()) &&
                  ((w = i.getScaleRatioFormatter()),
                  (y = this._getLabelData(x, w.format(v))),
                  (y.horzAlign = s > 0 ? 'left' : 'right'),
                  (y.vertAlign = n > 0 ? 'bottom' : 'top'),
                  (y.offsetX = s > 0 ? 10 : -10),
                  (y.offsetY = n > 0 ? -10 : 10),
        ...
        return (
          ...
          (t.prototype._updateImpl = function() {
            ...
            e.prototype._updateImpl.call(this),
              ...
              (i = this._getPoints()),
              (n = t.getScreenPoints()),
              i.length < 2 || n.length < 2 || ((r = n[0]), (s = n[1]), (i[1] = r), (i[1].data = 1), (i[2] = s));
          }),
          (t.prototype._initRenderers = function() {
            var e,
              t,
            ...
            for (e = 0; e < r; e++)
              this._verticalLevelsRenderers.push(new a.TrendLineRenderer()),
                this._horizontalLevelsRenderers.push(new a.TrendLineRenderer());
            for (t = n.fanLinesCount(), e = 0; e < t; e++) this._fanRenderers.push(new a.TrendLineRenderer());
            for (i = n.arcsCount(), e = 0; e < i; e++) this._arcRenderers.push(new d.GannArcRenderer());
          }),
          (t.prototype._prepareLevels = function(e, t) {
            var i,
              n,
            ...
            for (i = 0, n = S; i < n.length; i++)
              (s = n[i]),
                s.visible &&
                  ...
                  (d = void 0),
                  (c = void 0),
                  a > o ? ((d = v.x), (p = o / a), (c = g.y + p * x)) : ((c = v.y), (p = a / o), (d = g.x + p * m)),
                  (_ = {
    ...
    inherit(n, s),
      ...
      (n.prototype.updateImpl = function() {
        ...
        if (
          ...
          for (
            e = this._floatPoints[0], t = this._floatPoints[1], this._fans = [], i = t.x - e.x, n = t.y - e.y, o = 1;
            o <= 9;
            o++
          )
            (l = 'level' + o),
              ...
              h.visible.value() &&
                ...
                (_ = h.color.value()),
                (u = d + '/' + c),
                d > c ? ((r = t.x), (a = e.y + n / p)) : ((r = e.x + i * p), (a = t.y)),
                this._fans.push({
                  label: u,
                  color: _,
                  x: r,
          ...
          (_ = new r(this._fans[p].x, this._fans[p].y)),
            n &&
              (this._fans[p].index < 4
                ? ((u = new r(this._fans[p + 1].x, this._fans[p + 1].y)),
                  (f = {}),
  ...
  1159: function(e, t, i) {
    'use strict';
    function n(e, t) {
      l.call(this, e, t), (this._invalidated = !0), (this._medianRenderer = new h()), (this._sideRenderer = new h());
    }
    function r(e, t) {
      n.call(this, e, t), (this._invalidated = !0), (this._backSideRenderer = new h());
    }
    function s(e, t) {
    ...
    var o = i(8).Point,
      ...
      h = i(110).TrendLineRenderer,
      d = i(1216).ChannelRenderer,
      c = i(11),
      p = i(53).CompositeRenderer,
      _ = i(74).LineEnd;
    inherit(n, l),
      (n.prototype.update = function() {
        this._invalidated = !0;
      ...
      (n.prototype.renderer = function() {
        var e, t, i, n, r, s, a, o, l, u, f, g, v, w, y, m, x, b, S, P, R;
        if (
          (this._invalidated && (this.updateImpl(), (this._invalidated = !1)),
          (e = new p()),
          this._floatPoints.length < 2)
      ...
      (r.prototype.renderer = function() {
        ...
        for (
          ...
          (f = 'level' + u),
            ...
            g.visible.value() &&
              ((v = this._medianPoint.addScaled(r, g.coeff.value())),
              (w = v.add(s)),
              (y = this._medianPoint.addScaled(r, -g.coeff.value())),
              (m = y.add(s)),
              o &&
                ((t = {}),
                (t.p1 = v),
      ...
      (a.prototype.renderer = function() {
        ...
        if (
          ...
          return e;
        if (!this._medianPoint || !this._modifiedBase) return this.addAnchors(e), e;
        if (
          (3 === this._floatPoints.length &&
            ((t = {
        ...
        for (
          ...
          (g = 'level' + f),
            ...
            v.visible.value() &&
              ((w = this._medianPoint.addScaled(r, v.coeff.value())),
              (y = w.add(s)),
              (m = this._medianPoint.addScaled(r, -v.coeff.value())),
              (x = m.add(s)),
              o &&
                ((i = {}),
                (i.p1 = w),
  ...
  1160: function(e, t, i) {
    ...
    var r = i(371).LineSourcePaneView,
      s = i(1239).DisjointAngleRenderer,
      a = i(110).TrendLineRenderer,
      o = i(166).TextRenderer,
      l = i(53).CompositeRenderer,
      h = i(1199).PaneRendererClockIcon;
    inherit(n, r),
      (n.prototype.update = function() {
        this._invalidated = !0;
      }),
        ...
        return (
          ...
          this._points.length < 2
            ...
            : ((t = this._points[0]),
              ...
              e.append(this._trendLineRendererPoints12),
              v(this._p1LabelRenderer, this._p2LabelRenderer, t, i, this._price1, this._price2),
              2 === this._points.length
                ? (this.addAnchors(e), e)
                : (this._trendLineRendererPoints43.setData(f(r, n)),
                  e.append(this._trendLineRendererPoints43),
                  v(this._p3LabelRenderer, this._p4LabelRenderer, n, r, this._price3, this._price4),
                  this.isAnchorsRequired() &&
                    ((w = [t, i, n, r]),
                    ...
                    this._source.getAlertIsActive(function(n) {
                      e.append(
                        new h({
                          ...
                          color: n
                            ? s.linecolor.value()
                            : defaults('chartproperties.alertsProperties.drawingIcon.color'),
                        })
                      );
                    }),
                  e))
            ...
            : ((t = this._points[0]),
              ...
              2 === this._points.length
                ...
                : ((f = this),
                  ...
                  g(this._p1LabelRenderer, this._p2LabelRenderer, t, i, this._price1, this._price2),
                  this._trendLineRendererPoints43.setData(u(r, n)),
                  e.append(this._trendLineRendererPoints43),
                  g(this._p3LabelRenderer, this._p4LabelRenderer, n, r, this._price3, this._price3),
                  this.isAnchorsRequired() &&
                    ((v = [t, i, n, r]),
      ...
      (n.prototype.draw = function(e) {
        ...
        null != this._data &&
          ...
          this._data.selected &&
            ...
            e.fillRect(-this._cache[r] / 2, -this._data.size / 2, this._cache[r], this._data.size)),
      ...
      (n.prototype.hitTest = function(e) {
        ...
        return null === this._data
          ...
          : ((t = 65536 * this._data.icon + this._data.size),
            ...
            (r = l(n, r)),
            Math.abs(r.y) <= i / 2 && Math.abs(r.x) <= this._data.size / 2 ? new c(c.MOVEPOINT) : null);
      }),
      inherit(r, h),
      (r.prototype.update = function() {
        this._invalidated = !0;
  ...
  1163: function(e, t, i) {
    'use strict';
    function n(e, t) {
      a.call(this, e, t), (this._invalidated = !0), (this._poligonRenderer = new l());
    }
    var r = i(8).Point,
      s = i(44).distanceToLine,
      a = i(371).LineSourcePaneView,
      o = i(110).TrendLineRenderer,
      l = i(380),
      h = i(53).CompositeRenderer,
    ...
    inherit(n, a),
      ...
      (n.prototype.updateImpl = function() {
        a.prototype._updateImpl.call(this),
          (this._distance = 0),
          3 === this._points.length && (this._distance = s(this._points[0], this._points[1], this._points[2]).distance);
      }),
      (n.prototype.renderer = function() {
          ...
          0 === this._points.length
            ...
            : ((e = new h()),
              ...
              2 === this._points.length
                ...
                : 3 === this._points.length &&
                  ((u = n.subtract(i)),
                  (f = new r(u.y, -u.x).normalized().scaled(this._distance)),
                  (g = f.scaled(-1)),
                  (s = i.add(f)),
                  (a = n.add(f)),
                  (l = i.add(g)),
              ...
              this.isAnchorsRequired() &&
                ...
                3 === this._points.length &&
                  ((s.data = 2), (l.data = 2), (a.data = 2), (c.data = 2), v.push(s), v.push(l), v.push(a), v.push(c)),
                e.append(this.createLineAnchor({ points: v }))),
              e)
        );
      }),
  ...
  1164: function(e, t, i) {
    ...
    var s = i(371).LineSourcePaneView,
      a = i(110).TrendLineRenderer,
      o = i(11),
      l = i(53).CompositeRenderer,
      h = i(74).LineEnd;
    (n.prototype.setData = function(e) {
      ...
      (n.prototype._continiusFib = function(e) {
        var t,
          ...
          r = Math.floor(e),
          s = Math.ceil(e);
        return s >= n.length ? null : ((t = e - r), (t = Math.pow(t, 1.15)), (i = n[s] - n[r]), n[r] + i * t);
      }),
      (n.prototype.hitTest = function(e) {
        ...
        for (
          ...
          if (
            ...
            null !== (u = (u * n.length()) / 5) && Math.abs(u - c) < 5)
          )
      ...
      (n.prototype.draw = function(e) {
        ...
        if (null !== this._data) {
          for (
            ...
            (h = l * o), (d = this._continiusFib(l / a)), (c = Math.cos(h) * d), (p = Math.sin(h) * d), e.lineTo(c, p);
  ...
  1165: function(e, t, i) {
    ...
    var r = i(132).intersectLineSegments,
      s = i(371).LineSourcePaneView,
      a = i(110).TrendLineRenderer,
      o = i(1217).TriangleRenderer,
      l = i(166).TextRenderer,
      h = i(53).CompositeRenderer,
      d = i(30),
      c = i(74).LineEnd;
    inherit(n, s),
      ...
      (n.prototype.renderer = function() {
        ...
        for (
          e = this._source.properties(),
            ...
            r = function(t, n, r, s) {
              return {
                ...
                color: d.generateColor(i._source.properties().color.value(), r),
          ...
          (l = r(this._points[o - 1], this._points[o], 0)), (p = new a()), p.setData(l), t.append(p);
        return (
          this._points.length >= 5 &&
            ((f = !1),
            (g = !1),
            this._intersect1 ? (_ = this._intersect1) : ((_ = this._points[2]), (f = !0)),
            this._intersect2 ? (u = this._intersect2) : ((u = this._points[4]), (g = !0)),
            (l = r(_, u, 0)),
            (l.extendleft = f),
            (l.extendright = g),
            this._trendLineRenderer.setData(l),
            t.append(this._trendLineRenderer),
            (v = s(this._points[2], this._points[3], this._points[4])),
            this._triangleRendererPoints234.setData(v),
            t.append(this._triangleRendererPoints234)),
          this._intersect1 &&
            ((v = s(this._intersect1, this._points[1], this._points[2])),
            this._intersect1Renderer.setData(v),
            t.append(this._intersect1Renderer)),
          this._intersect2 &&
            ((v = s(this._points[4], this._points[5], this._intersect2)),
      ...
      (n.prototype.updateImpl = function() {
        ...
        s.prototype._updateImpl.call(this),
          ...
          this._points.length >= 5 &&
            ...
            (n = this._points[4]),
            (a = r(i, n, e, t)),
            null !== a && ((o = n.subtract(i)), (this._intersect1 = i.add(o.scaled(a)))),
            7 === this._points.length &&
              ((l = this._points[5]),
              (h = this._points[6]),
              null !== (a = r(i, n, l, h)) && ((o = n.subtract(i)), (this._intersect2 = i.add(o.scaled(a))))));
      }),
    ...
    inherit(n, r),
      ...
      (n.prototype.renderer = function() {
        ...
        return (
          ...
          this._renderer.setData(e),
          this.isAnchorsRequired() ? ((t = new s()), t.append(this._renderer), this.addAnchors(t), t) : this._renderer
        );
      }),
            ...
            : ((e = this._source.properties()),
              ...
              4 === this._points.length &&
                ...
                this._intersectPoint
                  ? ((a = [this._startPoint1, this._startPoint2, this._intersectPoint]),
                    (o = {}),
                    (o.points = a),
                  ...
                  : this._intersectPoint1 &&
                    ...
                    ((a = [this._startPoint1, this._startPoint2, this._intersectPoint2, this._intersectPoint1]),
                    (o = {}),
                    (o.filled = !0),
                    (o.fillBackground = !0),
                    (o.points = a),
    ...
    inherit(n, r),
      (n.prototype.renderer = function() {
        ...
        for (
          e = this._source.properties(),
            ...
            r = function(t, n, r, s) {
              return {
                ...
                width: i._model.timeScale().width(),
                height: i._source.priceScale().height(),
                color: h.generateColor(i._source.properties().color.value(), r),
                linewidth: s || e.linewidth.value(),
                linestyle: CanvasEx.LINESTYLE_SOLID,
                extendleft: !1,
                extendright: !1,
          ...
          (l = r(this._points[a - 1], this._points[a], 0)), (c = new s()), c.setData(l), t.append(c);
        return (
          this._retrace1 &&
            ...
            (_ = n(p, this._numericFormatter.format(this._retrace1))),
          ...
          this._retrace2 &&
            ...
            (_ = n(p, this._numericFormatter.format(this._retrace2))),
      ...
      (n.prototype.updateImpl = function() {
        ...
        r.prototype._updateImpl.call(this),
          ...
          this._source.points().length >= 6 &&
            ...
            (this._retrace2 = Math.round(100 * Math.abs((s.price - n.price) / (n.price - i.price))) / 100));
      }),
            ...
            : ((e = this._source.properties()),
              ...
              (s = function(t, i, r, s) {
                return {
                  ...
                  width: n._model.timeScale().width(),
                  height: n._source.priceScale().height(),
                  color: h.generateColor(n._source.properties().color.value(), r),
                  linewidth: s || e.linewidth.value(),
                  linestyle: CanvasEx.LINESTYLE_SOLID,
                  extendleft: !1,
                  extendright: !1,
              ...
              i.length >= 3 &&
                ((a = s(i[1], i[2], 0)), this._lineRendererPoints12.setData(a), t.append(this._lineRendererPoints12)),
              4 === i.length &&
                ((a = s(i[2], i[3], 0)), this._lineRendererPoints23.setData(a), t.append(this._lineRendererPoints23)),
              ...
              this._points.length >= 3 &&
                ...
                (l = r(c, this._numericFormatter.format(this._ABRetracement))),
              ...
              this._points.length >= 4 &&
                ...
                (l = r(c, this._numericFormatter.format(this._CDRetracement))),
  ...
  1170: function(e, t, i) {
    ...
    var r = i(8).Point,
      ...
      d = i(53).CompositeRenderer,
      c = i(167).PercentageFormatter,
      p = i(89).NumericFormatter,
      _ = i(377).PipFormatter,
      u = i(30),
      f = i(74).LineEnd,
      g = i(408).RiskRewardPointIndex;
    inherit(n, s),
                ...
                (0 !== this._model.mainSeries().bars().length &&
                  ...
                  (i = this._source.lastBarData()) &&
                    ...
                    n.isPercent() &&
                      ...
                      (r = n.priceRange().convertToPercent(r, o)),
                      (a = n.priceRange().convertToPercent(a, o)),
                      (i.closePrice = n.priceRange().convertToPercent(i.closePrice, o))),
                    (this._entryLevel = this._points[g.Entry].y),
                    (this._stopLevel = t.priceToCoordinate(r)),
                    (this._profitLevel = t.priceToCoordinate(a)),
                    (this._closeLevel = t.priceToCoordinate(i.closePrice)),
        ...
        return (
          ...
          this._points.length < 2 || this._source.points().length < 2
            ...
            : ((t = this),
              ...
              (s = this._points[g.ActualEntry] ? this._points[g.ActualEntry].x : this._points[g.Close].x),
              (a = this._points[g.ActualClose] ? this._points[g.ActualClose].x : this._points[g.Close].x),
              ...
              (x = function(i, n, r, s) {
                ...
                (a.points = [n, r]),
                  ...
                  (a.color = s || t._source.properties().linecolor.value()),
                  (a.linewidth = t._source.properties().linewidth.value()),
              ...
              this._points[g.ActualEntry] &&
                ...
                (h = this._isClosed ? this._points[g.ActualClose] : new r(this._closeBar, this._closeLevel)),
                (c = {}),
                (c.points = [l, h]),
              ...
              (b = function(n, r, s, a, o, l, h) {
                if (t.isLabelVisible() || TradingView.printing) {
                  ...
                  (d.points = [r]),
                    ...
                    (d.backgroundColor = u.resetTransparency(a)),
              ...
              (B = new r((n + o) / 2, Math.round(this._points[0].y) + 0.5)),
              (M = ''),
              (A = ''),
              (D = this._numericFormatter.format(Math.round(100 * I) / 100)),
              this._points[1] &&
                void 0 !== this._pl &&
                (A = this._source
                  .priceScale()
              ...
              i.compact.value()
                ? ((M += A ? A + ' ~ ' : ''), (M += i.qty.value() + '\n'), (M += D))
                : ((E = this._isClosed ? this.i18nCache.closed : this.i18nCache.open),
                  (M += A ? this.i18nCache.pnl.format(E, A) + ', ' : ''),
                  (M += this.i18nCache.qty.format(i.qty.value()) + '\n'),
                  (M += this.i18nCache.ratio.format(D) + ' ')),
              (O = i.linecolor.value()),
              this._pl < 0 ? (O = i.stopBackground.value()) : this._pl > 0 && (O = i.profitBackground.value()),
              b(this._middleLabelRenderer, B, M, O, 'middle', 0, 'white'),
              (l = new r(n, this._stopLevel)),
              (h = new r(o, this._stopLevel)),
              x(this._stopLineRenderer, l, h, i.stopBackground.value()),
              (N = this._model.mainSeries().symbolInfo()),
              N &&
                N !== this._lastSymbolInfo &&
                ((this._pipFormatter = new _(N.pricescale, N.minmov, N.type, N.minmove2)), (this._lastSymbolInfo = N)),
              ...
              b(this._stopLabelRenderer, B, M, i.stopBackground.value(), S < P ? 'bottom' : 'top', S < P ? -12 : -1),
              (l = new r(n, this._profitLevel)),
              (h = new r(o, this._profitLevel)),
              x(this._targetLineRenderer, l, h, i.profitBackground.value()),
              ...
              this.isAnchorsRequired() &&
                ...
                (Y = new r(o, F.y)),
                (Y.data = 3),
                e.append(this.createLineAnchor({ points: [F, W, H, Y] }))),
              e)
        );
      }),
  ...
  1171: function(e, t, i) {
    'use strict';
    function n(e, t) {
      r.call(this, e, t), (this._invalidated = !0), (this._renderer = new s());
    }
    var r = i(371).LineSourcePaneView,
      s = i(380),
      a = i(53).CompositeRenderer;
    inherit(n, r),
      (n.prototype.update = function() {
        this._invalidated = !0;
      }),
      ...
      (n.prototype.renderer = function() {
        ...
        return (
          ...
          (e.transparency = this._source.properties().transparency.value()),
          this._renderer.setData(e),
          this.isAnchorsRequired() ? ((t = new a()), t.append(this._renderer), this.addAnchors(t), t) : this._renderer
        );
      }),
  ...
  1172: function(e, t, i) {
    ...
    var s = i(8).Point,
      ...
      _ = i(1240),
      u = i(54),
      f = i(167).PercentageFormatter,
      g = i(177).DateFormatter,
      v = i(135).TimeFormatter,
    ...
    (n.prototype.setData = function(e) {
      ...
      (n.prototype.drawTargetLabel = function(e) {
        ...
        if (
          ...
          e.save(),
          (e.fillStyle = y.generateColor(this._data.targetBackColor, this._data.transparency)),
          e.fill(),
          e.restore(),
          e.save(),
          (e.lineWidth = 2),
          (e.strokeStyle = y.generateColor(this._data.targetStrokeColor, this._data.transparency)),
          e.stroke(),
          e.restore(),
          (d = 3),
          e.beginPath(),
          ...
          (e.font = 'normal ' + this._targetFontSize3 + 'px ' + this._font),
          e.fillText(this._data.targetLine1, h.x + c, h.y + this._targetFontSize1 + p),
          (_ = 13),
          (u = 5),
          e.fillText(this._data.targetLine2, h.x + c + i + u, h.y + this._targetFontSize1 + p),
          (e.font = 'normal ' + this._targetFontSize2 + 'px ' + this._font),
          (f = h.y + this._targetFontSize1 + 2 * p + this._targetFontSize2),
          e.fillText(this._data.targetLine3, h.x + c, f),
          e.drawImage(this._data.clockWhite, h.x + c + r + 6, f - this._targetFontSize2 + 3),
          e.fillText(this._data.targetLine4, h.x + c + r + _ + 5, f),
          !this._data.status)
        )
          return void e.restore();
        switch (
          ((g = this._targetFontSize1 + 4),
          (e.font = 'bold ' + this._targetFontSize1 + 'px ' + this._font),
          this._data.status)
        ) {
          case m.AlertStatus.Success:
            (v = $.t('SUCCESS')),
              (w = y.generateColor(this._data.successBackground, this._data.transparency)),
              (x = this._data.successTextColor),
              (b = this._data.successIcon);
            break;
          case m.AlertStatus.Failure:
            (v = $.t('FAILURE')),
              (w = y.generateColor(this._data.failureBackground, this._data.transparency)),
      ...
      (n.prototype.drawStartLabel = function(e) {
        ...
        e.save(),
          ...
          (e.fillStyle = y.generateColor(this._data.sourceBackColor, this._data.transparency)),
          e.fill(),
          (e.lineWidth = 2),
          (e.strokeStyle = y.generateColor(this._data.sourceStrokeColor, this._data.transparency)),
          e.stroke(),
          (o = 3),
          e.beginPath(),
          ...
          (e.font = 'normal ' + this._sourceFontSize1 + 'px ' + this._font),
          e.fillText(this._data.sourceLine1, a.x + l, a.y + this._sourceFontSize1 + h),
          (e.font = 'normal ' + this._sourceFontSize2 + 'px ' + this._font),
          e.fillText(this._data.sourceLine2, a.x + l, a.y + this._sourceFontSize1 + 2 * h + this._sourceFontSize2),
          e.restore();
      }),
      (n.prototype.draw = function(e) {
        ...
        if (!(null === this._data || this._data.points.length < 2)) {
          if (
            ...
            if (
              ((o = Math.abs(n.x)), (l = Math.abs(n.y)), (h = 0), (d = Math.PI / 2), (c = (h + d) / 2), n.length() > r)
            )
              for (;;) {
                if (
                  ((p = o * Math.sin(c)),
      ...
      (n.prototype.targetLabelHitTest = function(e) {
        ...
        return (
          ...
          (l = Math.min(a, o)),
          (h = Math.max(a, o)),
          e.x >= s && e.x <= s + t && e.y >= l && e.y <= h ? new c(c.MOVEPOINT) : null
        );
      }),
      (n.prototype.sourceLabelHitTest = function(e) {
        var t = 1.5 * this._sourceFontSize1 + 1.5 * this._sourceFontSize2,
          ...
          _ = Math.min(d, p),
          u = Math.max(d, p);
        return e.x >= h && e.x <= h + r && e.y >= _ && e.y <= u ? new c(c.MOVEPOINT) : null;
      }),
      (n.prototype.hitTest = function(e) {
        var t, i, n, r, s, a, o, l;
        return null === this._data || this._data.points.length < 2
          ...
          : ((t = this._data.points[0]),
            ...
            (s = Math.abs(n.x)),
            (a = Math.abs(n.y)),
            (o = u.sign(n.y) * (a - a * Math.sqrt(1 - (r.x * r.x) / (s * s)))),
            (l = 3),
            Math.abs(o - r.y) < l ? new c(c.MOVEPOINT) : this.targetLabelHitTest(e) || this.sourceLabelHitTest(e));
      }),
      inherit(r, h),
      (r.prototype.renderer = function() {
        var e, t, i;
        return (
          ...
          (e.transparency = this._source.properties().transparency.value()),
          (e.targetBackColor = this._source.properties().targetBackColor.value()),
          (e.targetStrokeColor = this._source.properties().targetStrokeColor.value()),
          (e.targetTextColor = this._source.properties().targetTextColor.value()),
          (e.sourceBackColor = this._source.properties().sourceBackColor.value()),
          (e.sourceStrokeColor = this._source.properties().sourceStrokeColor.value()),
          (e.sourceTextColor = this._source.properties().sourceTextColor.value()),
          (e.successBackground = this._source.properties().successBackground.value()),
          (e.successTextColor = this._source.properties().successTextColor.value()),
          (e.failureBackground = this._source.properties().failureBackground.value()),
          (e.failureTextColor = this._source.properties().failureTextColor.value()),
          (e.intermediateBackColor = this._source.properties().intermediateBackColor.value()),
          (e.intermediateTextColor = this._source.properties().intermediateTextColor.value()),
          ...
          (t = l(o(this._model._properties.paneProperties.background.value()), 150)),
          (e.centersColor = 'black' === t ? 'white' : 'black'),
          this._renderer.setData(e),
          this.isAnchorsRequired() ? ((i = new p()), i.append(this._renderer), this.addAnchors(i), i) : this._renderer
        );
      }),
      (r.prototype.update = function() {
        this._invalidated = !0;
        ...
        h.prototype._updateImpl.call(this),
          ...
          this._source.points().length < 2 ||
            (this._source.priceScale() &&
              ...
              (this._targetLine1 = n + this._targetLine1 + ' (' + n + this._percentageFormatter.format(r) + ')'),
              (s = this._model.timeScale().indexToUserTime(t.index)),
              (a = this._model.timeScale().indexToUserTime(e.index)),
              (o = t.time && e.time),
              o &&
                ((s = TradingView.isString(t.time) ? new Date(Date.parse(t.time)) : t.time),
                (a = TradingView.isString(e.time) ? new Date(Date.parse(e.time)) : e.time)),
              (l = this._model.mainSeries().isDWM()),
              (c = d.kind(this._model.mainSeries().interval()) === d.SECONDS),
              a &&
                s &&
                ((this._targetLine4 = new g().format(a)),
                l || (this._targetLine4 = this._targetLine4 + '  ' + new v(c ? '%h:%m:%s' : '%h:%m').format(a)),
                (p = (a.valueOf() - s.valueOf()) / 1e3),
                (this._targetLine2 = $.t('in', { context: 'dates' }) + ' ' + new w().format(p))),
              (this._sourceLine1 = this._source
                .priceScale()
                .formatter()
                .format(t.price)),
              (this._sourceLine2 = ''),
              (_ = this._model.timeScale().indexToUserTime(t.index)),
              _ &&
                ((this._sourceLine2 = new g().format(_)),
                l || (this._sourceLine2 = this._sourceLine2 + ' ' + new v(c ? '%h:%m:%s' : '%h:%m').format(_))),
              (this._direction = this._source.direction() === m.Direction.Up ? 'up' : 'down'),
              (this._finished =
  ...
  1173: function(e, t, i) {
    'use strict';
    function n(e, t) {
      (this._data = null), (this._measureCache = e), (this._chartModel = t), (this._points = null);
    }
    function r(e, t, i) {
      o.call(this, e, t),
        (this._image = c('price_label', TradingView.wrapUrl('/static/images/price_label.png'))),
        (this._rendererCache = {}),
        (this._invalidated = !0),
    ...
    (n.prototype.setData = function(e) {
      ...
      (n.prototype.draw = function(e) {
        ...
        null !== this._data &&
          ...
          this._measureCache &&
            $.extend(this._measureCache, { innerWidth: a, innerHeight: o, tailLeft: r, tailHeight: n }),
      ...
      (n.prototype.hitTest = function(e) {
        var t, i;
        return null === this._data || null === this._points || 0 === this._points.length
          ? null
          : ((t = this._points[0].x - this._measureCache.tailLeft),
            ...
            a(e, new s(t, i), new s(t + this._measureCache.innerWidth, i + this._measureCache.innerHeight))
              ? new h(h.MOVEPOINT)
              : null);
      }),
      inherit(r, o),
      ...
      (r.prototype.updateImpl = function() {
        var e, t, i;
        if ((o.prototype._updateImpl.call(this), this._source.points().length > 0)) {
          if (((e = this._source.points()[0].price), !(t = this._source.priceScale()) || t.isEmpty())) return;
          t.isPercent() && ((i = this._source.ownerSource().firstValue()), (e = t.priceRange().convertToPercent(e, i))),
      ...
      (r.prototype.renderer = function() {
        ...
        return (
          ...
          this.isAnchorsRequired() && 1 === e.points.length
            ? ((t = new d()), t.append(this._renderer), t.append(new l({ points: e.points })), t)
            : this._renderer
        );
      }),
  ...
  1174: function(e, t, i) {
    ...
    var a = i(8).Point,
      ...
      l = i(371).LineSourcePaneView,
      h = i(166).TextRenderer,
      d = i(131).SelectionRenderer,
      c = i(11),
      p = i(53).CompositeRenderer,
      _ = i(30);
    (n.prototype.update = function(e) {
      ...
      (n.prototype.drawOn = function(e) {
        var t = new a(Math.round(this._data.point.x), Math.round(this._data.point.y)).add(this._translate);
        e.drawImage(this._sourceCanvas, t.x, t.y);
      }),
      (n.prototype.hasPoint = function(e) {
        var t = this._data.point.add(this._translate),
          i = new a(this._data.point.x - this._translate.x, this._data.point.y);
        return o(e, t, i);
      }),
      ...
      (r.prototype.draw = function(e) {
        null !== this._data && (this._source.drawOn(e), this._data.tooltipVisible && this.drawTooltipOn(e));
      }),
      (r.prototype.drawTooltipOn = function(e) {
        var t, i, n, r, s, a, o, l, d, c, p, u, f, g, v;
        for (
          e.save(),
            t = (this._data.text + '').replace(/^\s+|\s+$/g, '').replace(/[\r\n]+/g, '\n'),
            e.font =
            ...
            o = n.length * this._data.fontSize + 2 * this._data.tooltipPadding,
            ...
            l < 10
              ? (l += Math.abs(l - 10))
              : l + a + 10 > this._data.vpWidth && (l -= l + a + 10 - this._data.vpWidth),
            e.fillStyle = _.generateColor(this._data.backgroundColor, this._data.backgroundTransparency),
            e.strokeStyle = this._data.markerColor,
            e.lineWidth = 1,
            e.beginPath(),
            e.moveTo(l, d),
            c || 'top' !== p || (e.lineTo(u - 7, d), e.lineTo(u, d - 7), e.lineTo(u + 7, d)),
            e.lineTo(l + a, d),
            e.lineTo(l + a, d + o),
            c || 'bottom' !== p || (e.lineTo(u + 7, d + o), e.lineTo(u, d + o + 7), e.lineTo(u - 7, d + o)),
            e.lineTo(l, d + o),
            e.closePath(),
            e.fill(),
            e.stroke(),
            ...
            g = d + this._data.tooltipPadding + this._data.fontSize / 2,
            v = 0;
          v < n.length;
          v++
        )
          e.fillText(n[v].replace(/^\s+/, ''), f, g), (g += this._data.fontSize + s);
        e.restore();
      }),
      (r.prototype.hitTest = function(e) {
        return null !== this._data && this._source.hasPoint(e) ? new c(c.MOVEPOINT) : null;
      }),
      inherit(s, l),
      (s.prototype.update = function() {
        this._invalidated = !0;
  ...
  1175: function(e, t, i) {
    ...
    inherit(n, s),
      ...
      (n.prototype._smoothArray = function(e, t) {
        ...
        for (i = 0; i < e.length; i++) {
          for (n = new r(0, 0), s = 0; s < t; s++)
            (a = Math.max(i - s, 0)), (o = Math.min(i + s, e.length - 1)), (n = n.add(e[a])), (n = n.add(e[o]));
          l[i] = n.scaled(0.5 / t);
        }
      ...
      (n.prototype.renderer = function() {
        var e, t, i, n;
        return (
          this._invalidated && (this._updateInternal(), (this._invalidated = !1)),
          (e = {}),
          (t = this._source.properties()),
          (e.points = this._points),
          ...
          this.isAnchorsRequired() && this._source.finished()
            ? ((i = new l()),
              ...
              e.points.length > 0 &&
                ((n = [e.points[0], e.points[e.points.length - 1]]), i.append(new o({ points: n }))),
              i)
  ...
  1176: function(e, t, i) {
    ...
    var s = i(8).Point,
      a = i(44).distanceToLine,
      o = i(382),
      l = o.rotationMatrix,
      h = o.scalingMatrix,
      d = o.translationMatrix,
      c = o.transformPoint,
      p = i(371).LineSourcePaneView,
      _ = i(11),
      u = i(53).CompositeRenderer,
      f = i(30);
    (n.prototype.setData = function(e) {
      ...
      (n.prototype.draw = function(e) {
        ...
        if (!(null === this._data || this._data.points.length < 2)) {
          if (((t = this._data.points[0]), (i = this._data.points[1]), this._data.points.length < 3))
            return (
              (e.strokeStyle = this._data.color),
              (e.lineWidth = this._data.linewidth),
              e.beginPath(),
          ...
          (o = i.subtract(t)),
            ...
            e.stroke(),
            this._data.fillBackground &&
              ((e.fillStyle = f.generateColor(this._data.backcolor, this._data.transparency)), e.fill());
        }
      }),
      (n.prototype.hitTest = function(e) {
        ...
        return null === this._data || this._data.points.length < 3
          ...
          : ((t = 5),
            ...
            (o = a(i, n, r).distance) < 1
              ? ((o = a(i, n, e).distance), o < t ? new _(_.MOVEPOINT) : null)
              : ((p = n.subtract(i)),
                (u = p.length()),
                ...
                e.y * g.y < 0
                  ? null
                  : ((b = e.y < 0 ? new s(0.5 * u, (u * Math.sqrt(3)) / 2) : new s(0.5 * u, (-u * Math.sqrt(3)) / 2)),
                    (S = e.subtract(b)),
                    (P = S.length()),
                    Math.abs(P - u) <= t ? new _(_.MOVEPOINT) : null)));
      }),
      inherit(r, p),
      (r.prototype.update = function() {
        this._invalidated = !0;
                    ...
                    : ((o = e.points[1]),
                      ...
                      2 === e.points.length
                        ...
                        : (i.push(p),
                          ...
                          (R = h(1, m / (2 * f))),
                          (P = c(R, P)),
                          (T = P.y >= 0 ? new s(_.x, _.y) : new s(y.x, y.y)),
                          (T.data = 2),
                          i.push(T),
    ...
    !(function() {
      ...
      n.prototype.wordWrap = function(i, n) {
        ...
        if (
          ...
          return r;
        for (t.font = this.fontStyle(), s = [], a = 0; a < r.length; a++)
          if (((o = r[a]), (l = t.measureText(o).width) <= n)) s.push(o);
          else
            for (h = o.split(/([-\)\]\},.!?:;])|(\s+)/); h.length; ) {
              if (
                (d = ~~(((n / l) * (h.length + 2)) / 3)) <= 0 ||
                t.measureText(h.slice(0, 3 * d - 1).join('')).width <= n
              )
                for (; t.measureText(h.slice(0, 3 * (d + 1) - 1).join('')).width <= n; ) d++;
              else for (; d > 0 && t.measureText(h.slice(0, 3 * --d - 1).join('')).width > n; );
              if (d > 0) s.push(h.slice(0, 3 * d - 1).join('')), h.splice(0, 3 * d);
                ...
                else for (; p > 1 && t.measureText(c.substr(0, --p)).width > n; );
                p < 1 && (p = 1), s.push(c.substr(0, p)), (h[0] = c.substr(p)), (h[1] = '');
              }
      ...
      (n.prototype.draw = function(e) {
        ...
        if (!(null === this._data || this._data.points.length < 2)) {
          for (
            ...
            e.fillText(this._data.lines[g], c, p), (p += this._data.fontSize);
          e.restore();
        }
      }),
      inherit(r, a),
              ...
              : ((e = this._source.properties()),
                ...
                this.isAnchorsRequired()
                  ? ((n = new l()),
                    ...
                    t.wordWrapWidth &&
                      ((o = new s(r.x + (t.wordWrapWidth >> 1) + d.RoundRadius + d.TextMargins, r.y)),
                      (o.data = 1),
    ...
    (n.prototype.setData = function(e) {
      ...
      (n.prototype.draw = function(e) {
        ...
        null !== this._data &&
          ...
          this._measureCache && $.extend(this._measureCache, { innerWidth: r, innerHeight: s, padding: n }),
      ...
      (n.prototype.hitTest = function(e) {
        var t, i;
        return null !== this._data && 0 !== this._data.points.length && this._measureCache.padding
          ? ((t = this._data.points[0].x - (this._measureCache.padding.left + 20)),
  ...
  1179: function(e, t, i) {
    ...
    var r = i(8).Point,
      ...
      d = i(1199).PaneRendererClockIcon;
    inherit(n, s),
      (n.prototype.update = function() {
        this._invalidated = !0;
      }),
        ...
        return (
          ...
          this._source.properties().showLabel.value() &&
            ...
            'left' === s
              ? (a.x = 3)
              : 'right' === s
              ? ((a.x = this._model.timeScale().width()), (h = -5))
              : (a.x = this._model.timeScale().width() / 2),
            'middle' === n ? (o = -this._source.properties().fontsize.value() / 6) : 'bottom' === n && (o = -4),
            (c = {
              points: [a],
              text: i.text.value(),
          ...
          1 === this._points.length &&
            this.isAnchorsRequired() &&
            ((p = new r(this._model.timeScale().width() / 2, this._points[0].y)),
            (p.data = 0),
          ...
          TradingView.printing ||
            ...
            this._model.readOnly() ||
            1 !== this._points.length ||
            ((_ = new r(this._model.timeScale().width() / 2, this._points[0].y)),
            this._source.getAlertIsActive(function(i) {
              e.append(
                new d({
                  point1: _,
  ...
  1180: function(e, t, i) {
    ...
    function r(e, t) {
      s.call(this, e, t), (this._invalidated = !0), (this._renderer = new n()), (this._labelRenderer = new a({}));
    }
    var s = i(371).LineSourcePaneView,
      a = i(166).TextRenderer,
      o = i(11),
      ...
      (r.prototype.renderer = function() {
        ...
        return (
          ...
          this._source.properties().showLabel.value() &&
            ...
            (d = 0),
            'right' === r
              ? ((s.x = this._model.timeScale().width()), (d = -5))
              : 'center' === r && (s.x = (s.x + this._model.timeScale().width()) / 2),
            'middle' === n ? (a = -this._source.properties().fontsize.value() / 6) : 'bottom' === n && (a = -4),
            (c = {
              points: [s],
              text: i.text.value(),
              color: i.textcolor.value(),
            ...
            : ((e = {}),
              ...
              this.isAnchorsRequired()
                ? ((t = new a()),
                  ...
                  (o = new r(n.x, i.y)),
                  (o.data = 3),
                  t.append(this.createLineAnchor({ points: [i, n, s, o] })),
                  t)
                : this._renderer)
        );
      }),
      ...
      (n.prototype.draw = function(e) {
        ...
        if (!(null === this._data || this._data.points.length < 2)) {
          ...
          (o = i.subtract(t)),
            ...
            e.rotate(w),
            e.scale(1, (2 * r) / u),
            e.arc(0, 0, 0.5 * u, this._data.angleFrom, this._data.angleTo, this._data.clockwise),
            e.restore(),
            e.stroke(),
            this._data.fillBackground &&
              ((e.fillStyle = f.generateColor(this._data.backcolor, this._data.transparency)), e.fill());
                ...
                ? ((t = new u()),
                  ...
                  2 === this._points.length
                    ...
                    : ((r = e.points[2]),
                      ...
                      (g = new s(c.x, c.y)),
                      (g.data = 3),
                      t.append(this.createLineAnchor({ points: [p, _, f, g] })),
                      t))
                : this._renderer)
        );
      }),
    ...
    (n.prototype.setData = function(e) {
      ...
      (n.prototype.draw = function(e) {
        null !== this._data &&
          ...
          e.stroke(),
          this._data.fillBackground &&
            ((e.fillStyle = h.generateColor(this._data.backcolor, this._data.transparency)), e.fill()));
      }),
      (n.prototype.hitTest = function(e) {
        var t, i, n, r, a;
        return null === this._data || e.y > this._data.point.y
          ? null
          : e.x < this._data.point.x || e.x > this._data.point.x + this._data.width
          ? null
          : ((t = new s(this._data.point.x + this._data.width / 2, this._data.point.y)),
            (i = e.subtract(t)),
            (n = this._data.height / this._data.width),
            (i.y /= n),
            (r = i.length()),
            (a = 3),
            Math.abs(r - this._data.width / 2) < a ? new o(o.MOVEPOINT) : null);
      }),
      inherit(r, a),
      (r.prototype.update = function() {
        this._invalidated = !0;
      ...
      (r.prototype.renderer = function() {
        ...
        if (
          ...
          return null;
        for (f = Math.min(h.x, d.x), g = [], v = r; f > -c; v -= o) (f = u.indexToCoordinate(v)), g.push(f);
        for (f = Math.max(h.x, d.x), v = a; f < u.width(); v += o) (f = u.indexToCoordinate(v)), g.push(f);
  ...
  1184: function(e, t, i) {
    ...
    (n.prototype.draw = function(e) {
      ...
      (n.prototype.hitTest = function(e) {
        var t, i, n, r;
        return e.x < this._data.point.x || e.x > this._data.point.x + 2 * this._data.width
          ? null
      ...
      (r.prototype.renderer = function() {
        ...
        if (
          ...
          return null;
        for (g = f.indexToCoordinate(r), v = [], w = r; g > -c; w -= o) (g = f.indexToCoordinate(w)), v.push(g);
        for (g = g = f.indexToCoordinate(r + o), w = r + o; g < f.width(); w += o)
  ...
  1185: function(e, t, i) {
    ...
    inherit(n, s),
      ...
      (n.prototype.renderer = function() {
        ...
        for (
          this._invalidated && (this.udpateImpl(), (this._invalidated = !1)), e = new h(), t = 1;
  ...
  1186: function(e, t, i) {
    ...
    function r(e, t) {
      a.call(this, e, t), (this._invalidated = !0), (this._renderer = new n());
    }
    var s = i(44).distanceToSegment,
      a = i(371).LineSourcePaneView,
      o = i(110).TrendLineRenderer,
      l = i(11),
      h = i(53).CompositeRenderer,
        ...
        if (null !== this._data)
          if (
            ...
            if (
              ...
              for (
                l = this._data.extendLeftPoints[this._data.extendLeftPoints.length - 1],
                  e.moveTo(l.x, l.y),
            ...
            for (
              e.quadraticCurveTo(s.x, s.y, n.x, n.y), e.quadraticCurveTo(a.x, a.y, i.x, i.y), h = 0;
              h < this._data.extendRightPoints.length;
              h++
            )
              (p = this._data.extendRightPoints[h]), e.lineTo(p.x, p.y);
            e.stroke(),
              this._data.leftend === c.Arrow && o.prototype.drawArrow(s, t, e, e.lineWidth),
              this._data.rightend === c.Arrow && o.prototype.drawArrow(a, i, e, e.lineWidth);
          }
      }),
      (n.prototype.hitTest = function(e) {
        var t, i, n, r, a, o, h, d;
        if (null !== this._data && 3 === this._data.points.length) {
          if (
            ...
            p.quadroBezierHitTest(n, t, a, e) || p.quadroBezierHitTest(n, i, o, e))
          )
            return new l(l.MOVEPOINT);
          for (h = 3, d = 1; d < this._data.extendLeftPoints.length; d++)
            if (
              ((t = this._data.extendLeftPoints[d - 1]), (i = this._data.extendLeftPoints[d]), s(t, i, e).distance < h)
            )
              return new l(l.MOVEPOINT);
        ...
        (this._extendLeftPoints = []),
          ...
          this._source.points().length < 3 ||
            ...
            this._source.properties().extendLeft.value() &&
              (this._extendLeftPoints = p.extendQuadroBezier(i, e, r, a, o)),
            this._source.properties().extendRight.value() &&
              (this._extendRightPoints = p.extendQuadroBezier(i, t, s, a, o)));
      }),
      (r.prototype.renderer = function() {
        var e, t, i, n;
        return this._points.length < 2
          ...
          : (this._invalidated && (this.updateImpl(), (this._invalidated = !1)),
            ...
            this._source._controlPoint && e.push(this._source.pointToScreenPoint(this._source._controlPoint)[0]),
            (t = {}),
            (i = this._source.properties()),
            (t.points = e),
        ...
        if (null !== this._data)
          if (
            ...
            e.beginPath(),
              ...
              e.lineTo(i.x, i.y),
              e.stroke(),
              this._data.leftend === c.Arrow && o.prototype.drawArrow(i, t, e, e.lineWidth),
              this._data.rightend === c.Arrow && o.prototype.drawArrow(t, i, e, e.lineWidth);
          else {
            if (
              ((n = this._data.points[2]),
              ...
              for (
                u = this._data.extendLeftPoints[this._data.extendLeftPoints.length - 1],
                  e.moveTo(u.x, u.y),
            ...
            e.stroke(),
              this._data.leftend === c.Arrow && o.prototype.drawArrow(a, t, e, e.lineWidth),
              this._data.rightend === c.Arrow && o.prototype.drawArrow(_, i, e, e.lineWidth);
          }
      }),
      (n.prototype.hitTest = function(e) {
        ...
        if (4 === this._data.points.length) {
          ...
          for (u = 3, f = 1; f < this._data.extendLeftPoints.length; f++)
            if (
              ((t = this._data.extendLeftPoints[f - 1]), (i = this._data.extendLeftPoints[f]), s(t, i, e).distance < u)
            )
              return new l(l.MOVEPOINT);
      ...
      (r.prototype.updateImpl = function() {
        ...
        (this._extendLeftPoints = []),
          ...
          this._source.points().length < 4 ||
            ...
            this._source.properties().extendLeft.value() &&
              (this._extendLeftPoints = p.extendQuadroBezier(i, e, s, l, h)),
            this._source.properties().extendRight.value() &&
              (this._extendRightPoints = p.extendQuadroBezier(n, t, o, l, h)));
      }),
      (r.prototype.renderer = function() {
        var e, t, i, n;
        return this._points.length < 2
          ...
          : (this._invalidated && (this.updateImpl(), (this._invalidated = !1)),
            ...
            this._source._controlPoints &&
              (e.push(this._source.pointToScreenPoint(this._source._controlPoints[0])[0]),
              e.push(this._source.pointToScreenPoint(this._source._controlPoints[1])[0])),
            (t = {}),
            (i = this._source.properties()),
            (t.points = e),
            (t.color = i.linecolor.value()),
    ...
    inherit(n, s),
      ...
      (n.prototype.updateImpl = function() {
        ...
        r.prototype._updateImpl.call(this),
          ...
          this._source.points().length >= 4 &&
            ((n = this._source.points()[3]),
            (this._BCRetracement = Math.round(1e3 * Math.abs((n.price - e.price) / (t.price - e.price))) / 1e3)),
          this._source.points().length >= 5 &&
            ((s = this._source.points()[4]),
            (this._CDRetracement = Math.round(1e3 * Math.abs((s.price - n.price) / (n.price - i.price))) / 1e3),
            (this._XDRetracement = Math.round(1e3 * Math.abs((s.price - n.price) / (e.price - n.price))) / 1e3));
      }),
      (t.CypherPaneView = n);
  },
  1189: function(e, t, i) {
    ...
    function r(e, t) {
      s.call(this, e, t), (this._rendererCache = {}), (this._renderer = new n(this._rendererCache, e._adapter));
    }
    var s = i(371).LineSourcePaneView,
      a = i(170),
      o = i(11),
      l = i(1242).splitThousands;
    (n.prototype.setData = function(e) {
      this._data = e;
    }),
      (n.prototype._height = function() {
        return Math.max(
          20,
          1 + Math.max(a.fontHeight(this._adapter.getBodyFont()), a.fontHeight(this._adapter.getQuantityFont()))
        );
      }),
      ...
      (n.prototype._drawReverseButton = function(e, t, i) {
        ...
        e.save(),
          ...
          (s = function(e, t) {
            CanvasEx.drawLine(e, 0, 0, 0, t), CanvasEx.drawLine(e, -1, 1, 1, 1), CanvasEx.drawLine(e, -2, 2, 2, 2);
          }),
          (a = 6),
          (o = 10),
      ...
      (n.prototype._drawCloseButton = function(e, t, i) {
        ...
        e.save(),
          ...
          (h = (this._height() - o) / 2),
          CanvasEx.drawPoly(e, [{ x: t + l, y: i + h }, { x: s - l, y: a - h }], !0),
          CanvasEx.drawPoly(e, [{ x: s - l, y: i + h }, { x: t + l, y: a - h }], !0),
          this._adapter._blocked &&
            ((e.fillStyle = 'rgba(140, 140, 140, 0.75)'), e.fillRect(t + 0.5, i + 0.5, n - 1, r - 1)),
          e.restore();
      }),
      ...
      (n.prototype.hitTest = function(e) {
        return null === this._data || 0 === this._data.points.length
          ? null
          : e.y < this._cache.top || e.y > this._cache.bottom || e.x < this._cache.left || this._cache.right < e.x
          ? null
          : this._adapter._blocked
          ? new o(o.CUSTOM, {})
          ...
          : new o(o.REGULAR, { mouseDownHandler: function() {} });
      }),
      inherit(r, s),
      (r.prototype.renderer = function() {
        return (
  ...
  1190: function(e, t, i) {
    ...
    function r(e, t) {
      a.call(this, e, t), (this._rendererCache = {}), (this._renderer = new n(this._rendererCache, e._adapter));
    }
    var s = i(170),
      a = i(371).LineSourcePaneView,
      o = i(11),
    ...
    (n.prototype.setData = function(e) {
      ...
      (n.prototype._drawCancelButton = function(e, t, i, n) {
        ...
        (e.strokeStyle = this._adapter.getCancelButtonBorderColor()),
          ...
          e.fillRect(t + 0.5, i + 0.5, r - 1, s - 1),
          this._adapter._blocked &&
            ((e.fillStyle = 'rgba(140, 140, 140, 0.75)'), e.fillRect(t + 0.5, i + 0.5, r - 1, s - 1)),
          e.save(),
          n && e.clip && (e.beginPath(), e.rect(t + 0.5, i - 0.5, r + 1, s + 1), e.clip()),
          e.strokeRect(t, i, r, s),
          e.restore(),
          ...
          (d = (this._height() - l) / 2),
          CanvasEx.drawPoly(e, [{ x: t + h, y: i + d }, { x: a - h, y: o - d }], !0),
          CanvasEx.drawPoly(e, [{ x: a - h, y: i + d }, { x: t + h, y: o - d }], !0);
      }),
      (n.prototype.draw = function(e) {
        var t, i, n, r, s, a, o, l, h, d, c;
        null === this._data ||
          ...
          (c = !1),
          0 !== i && (this._drawBody(e, l, d), this._drawMovePoints(e, l, d), this._drawBodyText(e, l, d), (c = !0)),
          0 !== n && (this._drawQuantity(e, l + i, d, c), this._drawQuantityText(e, l + i, d), (c = !0)),
          0 !== this._cancelButtonWidth() && this._drawCancelButton(e, l + i + n, d, c));
      }),
      (n.prototype.hitTest = function(e) {
        return null === this._data || 0 === this._data.points.length
          ? null
          ...
          ? null
          : this._adapter._blocked && e.x >= this._cache.left && e.x < this._cache.right
          ? new o(o.CUSTOM, {})
          : this._adapter._editable && e.x >= this._cache.left && e.x < this._cache.bodyRight
          ...
          : this._adapter._editable && e.x >= this._cache.quantityRight && e.x < this._cache.right
          ? new o(o.CUSTOM, {
  ...
  1199: function(e, t, i) {
    ...
    var r = i(8).Point,
      s = i(399).PaneRendererUnicodeChar;
    inherit(n, s), (t.PaneRendererClockIcon = TradingView.PaneRendererClockIcon = n);
  },
  1216: function(e, t, i) {
    'use strict';
    function n(e, t, i, n) {
      var r = s.equalPoints(i, n[0]) ? (s.equalPoints(i, n[1]) ? null : n[1]) : n[0];
      return null !== e && null !== r
        ? l.intersectPolygonAndHalfplane(e, s.halfplaneThroughPoint(s.lineThroughPoints(t, i), r))
        : null;
    }
    var r, s, a, o, l, h, d, c;
    Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        return (
          ...
          (e.prototype.draw = function(e) {
            ...
            if (null !== this._data && null !== (t = this._visiblePolygon())) {
              for (e.beginPath(), e.moveTo(t[0].x, t[0].y), i = 1; i < t.length; i++) e.lineTo(t[i].x, t[i].y);
              (e.fillStyle = d.generateColor(this._data.color, this._data.transparency, !0)), e.fill();
            }
          }),
          (e.prototype.hitTest = function(e) {
            if (null === this._data || !this._data.hittestOnBackground) return null;
            var t = this._visiblePolygon();
            return null !== t && a.pointInPolygon(e, t) ? new h(h.MOVEPOINT_BACKGROUND) : null;
          }),
          (e.prototype._visiblePolygon = function() {
            ...
            return s.equalPoints(a, l) ||
              s.equalPoints(h, d) ||
              (o.distanceToLine(a, l, h).distance < 1e-6 && o.distanceToLine(a, l, d).distance < 1e-6)
              ? null
              ...
              : ((e = [
                ...
                (t = n(t, a, l, [d, h])),
                (t = n(t, d, h, [a, l])),
                s.equalPoints(h, a) || (t = n(t, h, a, [l, d])),
                t);
          }),
          e
        );
        ...
        return (
          ...
          (e.prototype.draw = function(e) {
            ...
            null === this._data ||
              ...
              (e.strokeStyle = this._data.color),
              (e.lineWidth = this._data.linewidth),
              void 0 !== this._data.linestyle && o.setLineStyle(e, this._data.linestyle),
              (t = this._data.points),
              (i = t[0]),
              (n = t[1]),
              ...
              e.lineTo(i.x, i.y),
              this._data.fillBackground &&
                ((e.fillStyle = a.generateColor(this._data.backcolor, this._data.transparency)), e.fill()),
              e.stroke());
          }),
          (e.prototype.hitTest = function(e) {
            var t, i, a, o, l;
              ...
              : ((t = this._data.points),
                ...
                o.distance <= 3
                  ...
                  : ((l = this._data.points[2]),
                    ...
                    o.distance <= 3
                      ? new n(n.MOVEPOINT)
                      : ((o = r.distanceToSegment(l, i, e)),
                        o.distance <= 3
                          ? new n(n.MOVEPOINT)
                          : this._data.fillBackground && s.pointInTriangle(i, a, l, e)
                          ? new n(n.MOVEPOINT_BACKGROUND)
                          : null)));
          }),
          e
        );
  ...
  1219: function(e, t, i) {
    ...
    function n(e, t, i, n) {
      return null !== e
        ? o.intersectPolygonAndHalfplane(e, s.halfplaneThroughPoint(s.lineThroughPoints(t, i), n))
        : null;
    }
    var r, s, a, o, l, h, d, c, p;
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (p = (function() {
        function e(e, t) {
          (this._data = null),
            (this._hittestResult = e || new h(h.MOVEPOINT)),
            (this._backHittestResult = t || new h(h.MOVEPOINT_BACKGROUND));
        }
        return (
          (e.prototype.setData = function(e) {
            this._data = e;
          ...
          (e.prototype.draw = function(e) {
            ...
            null === this._data ||
              ...
              (e.strokeStyle = this._data.color),
              (e.lineWidth = this._data.linewidth),
              l.setLineStyle(e, this._data.linestyle),
              (t = this._data.points),
              (i = t[0]),
              (n = t[1]),
              ...
              4 === this._data.points.length &&
                ...
                (s = r[2]),
                (a = r[3]),
                this._data.skipLines || this._data.skipTopLine || this._extendAndDrawLineSegment(e, s, a),
                this._data.fillBackground && this._drawBackground(e, this._data.points),
                this._data.showMidline &&
                  !this._data.skipLines &&
                  ((e.strokeStyle = this._data.midcolor),
                  (e.lineWidth = this._data.midlinewidth),
                  l.setLineStyle(e, this._data.midlinestyle),
          ...
          (e.prototype._getColor = function() {
            var e = r.ensureNotNull(this._data);
            return c.generateColor(e.backcolor, e.transparency);
          }),
          (e.prototype._extendAndDrawLineSegment = function(e, t, i) {
            var n = this._extendAndClipLineSegment(t, i);
            null !== n && l.drawLine(e, n[0].x, n[0].y, n[1].x, n[1].y);
          }),
          (e.prototype._extendAndHitTestLineSegment = function(e, t, i) {
            var n,
              r = this._extendAndClipLineSegment(t, i);
            return null !== r && ((n = a.distanceToSegment(r[0], r[1], e)), n.distance <= 3)
              ? this._hittestResult
              : null;
          }),
          (e.prototype._extendAndClipLineSegment = function(e, t) {
            var i = r.ensureNotNull(this._data);
            return d.extendAndClipLineSegment(e, t, i.width, i.height, i.extendleft, i.extendright);
          }),
          (e.prototype._drawBackground = function(e, t) {
            var i,
              o,
              l,
              h = r.ensureNotNull(this._data),
              d = t[0],
              c = t[1],
              p = t[2],
              _ = t[3];
            if (
              !(
                s.equalPoints(d, c) ||
                s.equalPoints(p, _) ||
                a.distanceToLine(d, c, p).distance < 1e-6 ||
                a.distanceToLine(d, c, _).distance < 1e-6 ||
                h.width <= 0 ||
                h.height <= 0 ||
                ((i = [
                  new s.Point(0, 0),
                  new s.Point(h.width, 0),
                  new s.Point(h.width, h.height),
                  new s.Point(0, h.height),
                ]),
                (o = i),
                (o = n(o, d, c, _)),
                h.extendright || (o = n(o, c, _, p)),
                (o = n(o, _, p, d)),
                h.extendleft || (o = n(o, p, d, c)),
                null === o)
              )
            ) {
              for (e.beginPath(), e.moveTo(o[0].x, o[0].y), l = 1; l < o.length; l++) e.lineTo(o[l].x, o[l].y);
          ...
          (e.prototype.draw = function(e) {
            if (
              ...
              if (
                ...
                t.addColorStop(0, r.generateColor(this._data.color1, this._data.transparency)),
                  t.addColorStop(1, r.generateColor(this._data.color2, this._data.transparency)),
                  (e.fillStyle = t);
              } else e.fillStyle = r.generateColor(this._data.color, this._data.transparency, !0);
              e.fill();
            }
          }),
          (e.prototype.hitTest = function(e) {
            ...
            return null === this._data
              ...
              : ((t = e.subtract(this._data.center)),
                ...
                (s = Math.max(n, r)),
                (a = this._data.p1.subtract(this._data.p2).length()),
                s <= a)
                  ? this._hitTest
                  : this._data.fillBackground &&
                    i <= this._data.radius &&
                    ((o = this._data.p1.subtract(this._data.center).normalized()),
                    (l = this._data.p2.subtract(this._data.center).normalized()),
                    (h = t.normalized()),
                    (d = o.dotProduct(l)),
                    (c = h.dotProduct(o)),
                    (p = h.dotProduct(l)),
      ...
      (l = (function() {
        function e(e, t, i) {
          (this._data = e),
            ...
            (this._backgroundHitTest = i || new n(n.MOVEPOINT_BACKGROUND));
        }
        return (
          (e.prototype.draw = function(e) {
            var t, i, n, r, s, l, h, d;
            (e.lineCap = 'butt'),
              ...
              n < 1 ||
                ...
                this._data.wholePoints &&
                  ((h = this._data.wholePoints[0]), (d = this._data.wholePoints[1]), (l = Math.abs(h.x - d.x))),
                e.save(),
                e.translate(s.x, s.y),
                e.scale(1, r / n),
                e.beginPath(),
                ...
                this._data.fillBackground &&
                  ...
                  (e.fillStyle = a.generateColor(this._data.backcolor, this._data.transparency, !0)),
                  e.fill()));
          }),
          (e.prototype.hitTest = function(e) {
            var t, i, n, a, o, l, h, d, c, p;
              ...
              : ((t = this._data.points[0]),
                ...
                a < 1 || o < 1
                  ...
                  : ((d = (i.y - t.y) / (i.x - t.x)),
                    ...
                    (c = h.x * h.x + h.y * h.y),
                    (p = c - n * n),
                    (p = r.sign(p) * Math.sqrt(Math.abs(p / n))),
                    Math.abs(p) < 3
                      ? this._hitTest
                      : this._data.fillBackground && !this._data.noHitTestOnBackground && p < 3
          ...
          (e.prototype.draw = function(e) {
            ...
            null !== this._data &&
              ...
              this._data.fillBack &&
                ...
                (e.fillStyle = r.generateColor(this._data.color, this._data.transparency, !0)),
                e.fill()),
              e.beginPath(),
  ...
  1239: function(e, t, i) {
    'use strict';
    function n(e, t, i, n) {
      var r = l.equalPoints(i, n[0]) ? (l.equalPoints(i, n[1]) ? null : n[1]) : n[0];
      return null !== e && null !== r
        ? c.intersectPolygonAndHalfplane(e, l.halfplaneThroughPoint(l.lineThroughPoints(t, i), r))
        : null;
    }
    function r(e) {
      return l.line(1, 0, -e);
    ...
    function s(e, t, i) {
      return null !== e ? c.intersectPolygonAndHalfplane(e, l.halfplaneThroughPoint(r(t), new l.Point(i, 0))) : null;
    }
    function a(e, t) {
      var i = t.points,
        n = i[0],
        r = i[1];
      return t.extendleft || (e = s(e, n.x, r.x)), t.extendright || (e = s(e, r.x, n.x)), e;
    }
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      (g = (function() {
        ...
        return (
          (e.prototype.setData = function(e) {
            ...
            e.points.length < 4 ||
              ...
              (a =
                l.equalPoints(i, n) ||
                l.equalPoints(r, s) ||
                (d.distanceToLine(i, n, r).distance < 1e-6 && d.distanceToLine(i, n, s).distance < 1e-6)),
              a
                ? (this._selectedRenderer = null)
                : ((o = c.intersectLines(l.lineThroughPoints(i, n), l.lineThroughPoints(r, s))),
                  null !== o
          ...
          (e.prototype.hitTest = function(e) {
            return null !== this._selectedRenderer ? this._selectedRenderer.hitTest(e) : null;
          }),
          e
        );
      })()),
        ...
        return (
          ...
          (e.prototype.draw = function(e) {
            ...
            if (!(null === this._data || this._data.points.length < 4))
              for (
                e.fillStyle = f.generateColor(this._data.backcolor, this._data.transparency),
                  t = 0,
                  i = this._visiblePolygons();
                t < i.length;
                t++
              ) {
                for (n = i[t], e.beginPath(), e.moveTo(n[0].x, n[0].y), r = 1; r < n.length; r++)
          ...
          (e.prototype.hitTest = function(e) {
            ...
            for (t = 0, i = this._visiblePolygons(); t < i.length; t++)
              if (((n = i[t]), h.pointInPolygon(e, n))) return new _(_.MOVEPOINT_BACKGROUND);
            return null;
          }),
          (e.prototype._visiblePolygons = function() {
            ...
            return _.width <= 0 || _.height <= 0
              ? []
              : null === (e = c.intersectLines(l.lineThroughPoints(f, g), l.lineThroughPoints(v, w)))
              ? []
              : ((t = [
                  new l.Point(0, 0),
                ...
                (r = n(r, e, s, [h, h])),
                (r = a(r, _)),
                null !== (r = n(r, h, e, [s, s])) && i.push(r),
                (r = t),
                (d = g.subtract(f).add(e)),
                (p = v.subtract(w).add(e)),
                (r = n(r, e, d, [p, p])),
                (r = a(r, _)),
                null !== (r = n(r, p, e, [d, d])) && i.push(r),
                i);
          }),
          e
        );
  ...
  1240: function(e, t, i) {
    ...
    e.exports = function(e, t) {
      var i = document.body,
        n = i[e];
      return n || ((n = document.createElement('img')), (n.src = t), (i[e] = n)), n;
    };
  },
  1241: function(e, t, i) {
    'use strict';
    ...
    function r(e, t, i, n, r) {
      var s,
        ...
        h,
        d,
        c = i.subtract(e).length() + n.subtract(i).length() + t.subtract(n).length(),
        p = 3 / c;
      for (s = 0; s <= 1; s += p)
        if (
    ...
    function s(e, t, i, n, r) {
      ...
      for (s = 3 / u, a = 500, o = [], l = 1; l <= a * s; l += s)
        (h = e.scaled((1 - l) * (1 - l))),
          ...
          (c = t.scaled(l * l)),
          (p = h.add(d).add(c)),
          o.length > 0 && ((_ = o[o.length - 1]), _.subtract(p).length() < 2 && (s *= 2)),
          o.push(p);
      return o;
    }
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.quadroBezierHitTest = n),
      (t.cubicBezierHitTest = r),
      (t.extendQuadroBezier = s);
  },
  1242: function(e, t, i) {
    'use strict';
    function n(e, t) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.splitThousands = n);
  },
  249: function(e, t, i) {
    'use strict';
    function n(e, t) {
    ...
    var r = i(8).Point,
      ...
      d = i(1237).EllipseRendererSimple,
      c = i(166).TextRenderer,
      p = i(371).LineSourcePaneView,
      _ = i(110).TrendLineRenderer,
      u = i(11),
      f = i(53).CompositeRenderer,
      g = i(54),
      v = i(30),
      w = i(74).LineEnd;
    inherit(n, p),
      (n.prototype.renderer = function() {
        var e, t, i, n, s, p, v, w, y, m, x, b, S, P, R, T, L, C, k, I, B, M, A;
        if ((this._invalidated && (this.updateImpl(), (this._invalidated = !1)), !this._wave)) return null;
        for (
          e = this.isAnchorsRequired() ? 0 : 1, t = new f(), i = this._source.properties(), n = 0;
          n < this._wave.length;
          n++
        )
        ...
        for (
          p = 1,
            this._points.length > 2 && ((v = this._points[2]), (w = this._points[1]), (p = g.sign(v.y - w.y))),
            y = [],
            m = 0,
          ...
          n < e ||
            ...
            'circle' === P.decoration &&
              ...
              1 === p ? (T.y += 13 + P.fontIncrease / 2) : (T.y -= 14 + P.fontIncrease / 2),
              (L = (12 + P.fontIncrease) / 2 + 2),
              (v = T.subtract(new r(L, L))),
              (w = T.add(new r(L, L))),
              (C = { points: [v, w], color: l(o(a(S), 'black' === b ? 15 : -15)), linewidth: 1, fillBackground: !1 }),
              (k = new d(C)),
              t.append(k)),
            ...
            y.push(I),
            '' !== P && t.append(new c(I, new u(u.CHANGEPOINT, n))));
        if (this.isAnchorsRequired()) {
          for (B = [], M = 0; M < y.length; M++)
            (A = this._points[M].clone()), (A.y = y[M].points[0].y), (A.data = M), B.push(A);
          this._model.lineBeingCreated() === this._source && B.pop(), t.append(this.createLineAnchor({ points: B }));
        }
        return t;
      }),
      (n.prototype.update = function() {
          ...
          for (a = this._source.points(), o = 1; o < a.length; o++)
            (l = a[o - 1]),
              ...
              (y = {
                ...
                leftend: w.Circle,
                rightend: w.Circle,
                endstyle: { strokeWidth: 1, fillStyle: this._model.backgroundColor() },
          ...
          !(e = this._source.priceScale()) || e.isEmpty()
            ...
            : ((t = {}),
              ...
              i.fillBackground &&
                ...
                (t.backgroundTransparency = 1 - i.backgroundTransparency.value() / 100 || 0)),
              i.drawBorder && i.drawBorder.value() && (t.borderColor = i.borderColor.value()),
              i.wordWrap && i.wordWrap.value() && (t.wordWrapWidth = i.wordWrapWidth.value()),
              (t.bold = i.bold && i.bold.value()),
              (t.italic = i.italic && i.italic.value()),
              (t.highlightBorder = this._model.selectedSource() === this._source),
              n ||
                !i.fixedSize ||
                i.fixedSize.value() ||
                ((t.scaleX = this._source._model.timeScale().barSpacing() / this._source._barSpacing),
              ...
              this._renderer.setData(t),
              this.isAnchorsRequired() && 1 === t.points.length && !this._noSelection && t.wordWrapWidth
                ? ((d = new a()),
                  d.append(this._renderer),
                  (c = t.points[0]),
                  (p = new r(
                    c.x + t.wordWrapWidth + ~~(t.fontsize / 6),
                    c.y + (t.lines ? (t.lines.length * t.fontsize) / 2 + ~~(t.fontsize / 6) : 0)
                  )),
                  (p.data = 0),
    ...
    (n.prototype.setData = function(e) {
      ...
      (n.prototype.draw = function(e) {
        ...
        null !== this._data &&
          ...
          e.translate(-0.5, -0.5),
          e.drawImage(this._data.image, t, i, this._data.width, this._data.height));
      }),
      (n.prototype.hitTest = function(e) {
        if (null === this._data || 0 === this._data.points.length) return null;
        ...
        return (
          ...
          a(e, t, t.add(new s(this._data.width, this._data.height))) ? new l(l.MOVEPOINT) : null
        );
      }),
      inherit(r, o),
      ...
      (r.prototype.renderer = function() {
        ...
        if (
          ...
          if (((t = new d()), t.append(this._marksRenderer), this._anchorsOffset)) {
            for (i = [], n = 0; n < e.points.length; n++) i.push(e.points[n].clone().add(this._anchorsOffset));
