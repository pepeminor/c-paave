webpackJsonp([6, 12], {
      ...
      o(1300),
        ...
        (i.prototype.getSourceProperties = function() {
          ...
          for (t = 0; t < this._model.panes().length; t++) {
            for (e = this._model.panes()[t], o = [], i = e.orderedSources(), r = 0; r < i.length; r++)
              (s = i[r]), s.showInObjectTree() && o.push({ datasource: s, name: s.title() });
            for (n = e.dataSources(), r = 0; r < n.length; r++)
              (s = n[r]) instanceof l &&
                s.showInObjectTree() &&
                a.drawings.push({ datasource: s, name: s.title(), symbol: s.symbol() });
            o.length && a.groups.push({ children: o });
          }
          return a;
        }),
        (i.prototype.show = function() {
          var t, o, i, l, h, u, p, _, v, m;
          d('GUI', 'Objects Tree'),
            (t = []),
            (o = $()),
            (i = $('<div>')),
            ...
            (h = $('<div>')),
            (u = new n(l, this._chartWidget, this._model, h, i)),
            (o = o.add(i)),
            t.push({ customControl: i, name: $.t('Objects Tree'), page: h, onActivate: r.bind(null, u) }),
            (p = null),
            e.enabled('support_manage_drawings') &&
              ((_ = $('<div>')),
              (v = $('<div>')),
              (p = new a(l, this._chartWidget, this._model, v, _)),
              (o = o.add(_)),
              t.push({ customControl: _, name: $.t('Manage Drawings'), page: v, onActivate: r.bind(null, p) })),
            (m = c({
              tabs: t,
              width: 520,
              ...
              isClickOutFn: function(t) {
                if (
                  $(t.target)
                    ...
                    .andSelf()
                    .is(
                      '._tv-dialog, .properties-toolbar, .colorpicker, .tvcolorpicker-popup, .symbol-edit-popup, .context-menu, .js-dialog'
                    )
                )
                  return !1;
              },
            })),
            m.tabs.tabChanged.subscribe(null, function(e) {
              t[e].onActivate(t[e]);
  ...
  1247: function(t, e, o) {
    ...
    function i(t, e, o, i) {
      (this._sourcesPropertiesGetter = t),
        ...
        (this._$contentWrapper = $('<div class="tv-objects-tree-dialog-tab__content">').appendTo(this._$tabContainer)),
        (this._list = new s(this._chartModel, e)),
    ...
    var r = o(173).SidebarCustomScroll,
      s = o(1289).ObjectTreeItemsController,
      n = o(22),
      a = o(172).unifiedSpinner;
    o(1296),
      ...
      (i.prototype.initView = function() {
        this._chartModel.selectedSource() && (this._selectedItemId = this._chartModel.selectedSource().id()),
      ...
      (i.prototype._showSpinner = function() {
        (this.spinner = a().spin(this._$tabContainer.get(0))), this._$contentWrapper.css('visibility', 'hidden');
      }),
      ...
      (i.prototype._addScroll = function() {
        this._scroll = new r(this._$tabContainer, this._$contentWrapper, {
          showTopShadow: !1,
          showBottomShadow: !1,
          scrollMarginTop: 0,
        });
  ...
  1285: function(t, e, o) {
    ...
    var r = o(1286).ObjectsTreeTabFilter,
      s = o(1247);
    o(1297),
      inherit(i, s),
      (i.prototype.destroy = function() {
      ...
      (i.prototype.initView = function() {
        (this._filter = new r(this._$filterContainer)),
      ...
      (i.prototype._addSortableToList = function(t, e) {
        ...
        this._listAccessor().createSortableForItemsList(
          ...
          function(t, i) {
            ...
            if (o !== p) {
              for (
                r = o > p ? i.item.next() : i.item.prev(),
                  s = this._getSourceIdForItem(i.item),
                  n = this._getSourceIdForItem(r),
                  a = -1,
                  l = -1,
                  c = 0;
                c < e.length;
                ...
                (d = e[c]), d.datasource.id() === s ? (a = c) : d.datasource.id() === n && (l = c);
              for (
                h = this._chartModel.dataSourceForId(s),
              ...
              this._chartModel.endUndoMacro(), this._chartModel.on('changeZOrder', this._zorderChangedHandler);
            }
          }.bind(this)
        );
      }),
      (i.prototype._getNewSelectedIdOnRemoval = function(t) {
        var e = t.next();
        0 === e.length && (e = t.prev()), this._listAccessor().activateItem(e, this._getSourceForItem(e));
      }),
      ...
      (i.prototype._removeSourceFromView = function(t) {
        ...
        i && this._getNewSelectedIdOnRemoval(o),
          ...
          this._selectedSourceId() && i && this._scroll.scrollTo(this._getItemForSourceId(this._selectedSourceId()));
      }),
      (i.prototype._removeSourcesFromView = function(t) {
        this._renderView(
          function() {
      ...
      (i.prototype._subscribeListeners = function() {
        s.prototype._subscribeListeners.call(this),
      ...
      (i.prototype._unsubscribeListeners = function() {
        s.prototype._unsubscribeListeners.call(this),
        ...
        for (this._reloadItems(), t = this._getItems().groups, e = 0; e < t.length; ++e)
          if (((o = t[e]), o.children.length))
            for (i = o.children.length - 1; i >= 0; --i)
              (r = o.children[i]),
                (s = this._getItemForSourceId(r.datasource.id())),
                0 !== s.length && this._listAccessor().updateItem(s, r);
      }),
      ...
      (i.prototype._renderGroup = function(t) {
        ...
        (t = t || {}),
          ...
          (o = setInterval(
            function() {
              var r = t.items.slice(e, e + i._groupRenderSize);
              r.forEach(
                function(e) {
                  ...
                  this._markItemForSource(o, e.datasource),
                    e.datasource.id() === this._selectedSourceId() &&
                      this._listAccessor().activateItem(o, e.datasource),
                    t.$group.append(o);
                }.bind(this)
              ),
      ...
      (i.prototype._renderViewInternal = function(t) {
        var e,
          ...
          i,
          r,
          s = 'studies' !== this._filter.value() && this._items.drawings.length;
        for (this._fillListGroupsCount = 0, e = this._getItems().groups, o = 0; o < e.length; o++)
          (i = this._filter.applyToGroup(e[o].children)),
            i.length &&
              ((r = $('<div class="tv-objects-tree-tab__group">').appendTo(this._$contentWrapper)),
              this._addSortableToList(r, e[o].children),
              i.reverse(),
              this._renderGroup({ showLocks: s, callback: t, items: i, $group: r }),
  ...
  1286: function(t, e, o) {
    ...
    (function(e, i) {
      function r(t) {
        this._$filter = $(e.render(s, { filters: this._getActions() }))
          .appendTo(t)
          .tvDropdown();
        var o = this;
        this._$filter.on(Modernizr.touch ? 'touchend' : 'click', '.js-dropdown-item', function(t) {
          ...
          (this.onChange = new i()),
          this.setValue('all'),
          this._$filter.find('.js-dropdown-item[data-name="' + this._value + '"]').addClass('i-active');
      }
      var s,
        n = o(35).Study,
        a = o(77),
      ...
      o(175),
        ...
        (r.prototype.applyToGroup = function(t) {
          var e, o, i, r, s;
          if ('all' === this._value) return t;
          for (e = [], o = 0; o < t.length; o++)
            (i = t[o]),
              (r = TradingView.isInherited(i.datasource.constructor, a)),
              (s = TradingView.isInherited(i.datasource.constructor, 'drawings' === this._value ? n : l)),
              (!r && s) || e.push(i);
          return e;
        }),
        (r.prototype._getActions = function() {
          return [
        ...
        (t.exports.ObjectsTreeTabFilter = r);
    }.call(e, o(41), o(10)));
  },
  1287: function(t, e) {},
  1288: function(t, e) {},
  1289: function(t, e, o) {
    ...
    (function(e, i) {
      ...
      var s,
        ...
        h,
        u,
        p = o(1).LineDataSource,
        _ = o(1077),
        v = o(136).showEditObjectDialog,
        m = o(134).lazyJqueryUI;
      o(1290),
        (s = o(416)),
        (n = o(1291)),
        (a = o(1292)),
        ...
        (u =
          ...
          h +
          '</span></div></div>'),
        (r.prototype.setItemActivateListener = function(t) {
          this._itemActivateCallback = t;
        }),
        (r.prototype.setNodeExpandCollapseCallback = function(t) {
          this._nodeExpandCollapseCallback = t;
        }),
        (r.prototype.setNodeRemoveCallback = function(t) {
          this._nodeRemoveCallback = t;
        }),
        (r.prototype.activateItem = function(t, e, o) {
          (o && o.originalEvent.defaultPrevented) ||
            (this._$activeItem && 0 !== this._$activeItem.length && this._$activeItem.removeClass('i-active'),
            (this._$activeItem = t),
            this._$activeItem && 0 !== this._$activeItem.length && this._$activeItem.addClass('i-active'),
            this._itemActivateCallback && this._itemActivateCallback(e));
        }),
        (r.prototype.createSortableForItemsList = function(t, e, o) {
          m(t).sortable({
            scroll: !0,
        ...
        (r.prototype.createTreeNodeItem = function(t, e, o) {
          var r,
            s = $(
              i.render(u, {
                draggable: !1,
          ...
          return (
            ...
            (r = s.find('.js-remove-btn').attr('title', $.t('Delete all drawing for this symbol'))),
            r.click(
              function(e) {
                e.preventDefault(), this._nodeRemoveCallback && this._nodeRemoveCallback(s, t);
              }.bind(this)
            ),
            s
          );
        }),
        (r.prototype.createItem = function(t, e) {
          var o, r, s;
          return (
            (e = e || {}),
            (o = t.datasource),
            ...
            this.updateItem(s, t),
            s.click(this.activateItem.bind(this, s, o)),
            o.userEditEnabled() &&
              (e.lockUnlock && this._setupLockUnlockButton(s.find('.js-lock-unlock-btn'), o),
              e.showHide &&
                this._setupItemPropertyButton(
                  s.find('.js-show-hide-btn'),
                  o,
                  'visible',
                  $.t('Show/Hide'),
                  'Show/Hide ',
              ...
              r && this._setupEditAlertButton(s.find('.js-edit-alert-btn'), o),
              this._setupFormatButton(s.find('.js-format-btn'), o),
              this._canShowEditObjectDialog(o) &&
                (s.dblclick(
                  function() {
                    v(o, this._chartModel);
                  }.bind(this)
                ),
                e.addContextMenu &&
                  s.on(
                    'contextmenu',
                    function(t) {
                      this._showContextMenu(t, o), t.preventDefault();
                    }.bind(this)
                  )),
              this._setupItemRemoveButton(s.find('.js-remove-btn'), o)),
            s
          );
        }),
        (r.prototype.updateNodeItem = function(t, e, o, i) {
          var r = t.find('.js-title-container');
          r.toggleClass('i-bold', i.isCurrent), (r[0].innerHTML = e + ' (' + o.length + ')');
        }),
        ...
        (r.prototype._showContextMenu = function(t, o) {
          if (e.enabled('objects_tree_context_menu')) {
            this._chartWidget.paneByState(this._chartModel.paneForSource(o)).showContextMenuForSource(o, t);
          }
        }),
        (r.prototype._canShowEditObjectDialog = function(t) {
          return (
            !(t instanceof p && !t.isActualSymbol()) &&
            ((t !== this._chartModel.mainSeries() || !this._chartWidget || !this._chartWidget.onWidget()) &&
              (_.hasStylesPropertyPage(t) || _.hasInputsPropertyPage(t)))
          );
        }),
        (r.prototype._setupLockUnlockButton = function(t, e) {
          TradingView.isInherited(e.constructor, p)
            ? this._setupItemPropertyButton(t, e, 'frozen', $.t('Lock/Unlock'), 'Lock/Unlock ', !1)
            : t.addClass('i-hidden');
        }),
        (r.prototype._setupEditAlertButton = function(t, e) {}),
        (r.prototype._setupFormatButton = function(t, e) {
          if (!this._canShowEditObjectDialog(e)) return void t.addClass('i-hidden');
          t.attr('title', $.t('Format')).click(
            function() {
              v(e, this._chartModel);
            }.bind(this)
          );
        }),
        (r.prototype._setItemVisible = function(t, e) {
          var o = e.properties().visible.value();
          t.toggleClass('i-prop-hidden', !o);
        }),
        (r.prototype._setDataSourceIcon = function(t, e) {
          var o,
            i = t.find('.js-icon-container').empty();
          i.removeClass('i-text-icon i-empty'),
            (o = e.getSourceIcon()),
            null === o
              ? i.addClass('i-empty')
              : 'svg' === o.type
              ? $(o.svgCode)
                  ...
                  .appendTo(i)
              : 'text' === o.type && (i.addClass('i-text-icon'), i.text(o.text)),
            t.prepend(i);
        }),
        (r.prototype._onItemPropertyButtonClicked = function(t, e) {
          this._chartModel.setProperty(t, !t.value(), e);
        }),
        (r.prototype._onItemPropertyChanged = function(t, e, o) {
          t.toggleClass('i-active', e ? !o.value() : o.value());
        }),
        (r.prototype._syncStateAndSubscribe = function(t, e, o) {
          e.subscribe(null, this._onItemPropertyChanged.bind(this, t, o)), this._onItemPropertyChanged(t, o, e);
        }),
        (r.prototype._setupItemPropertyButton = function(t, e, o, i, r, s) {
          t.attr('title', i).click(
            function(t) {
              this._onItemPropertyButtonClicked(e.properties()[o], r + e.title());
            }.bind(this)
          ),
            this._syncStateAndSubscribe(t, e.properties()[o], s);
        }),
        (r.prototype._setupItemRemoveButton = function(t, e) {
        ...
        (r.prototype._onNodeToggleExpandCollapse = function(t, e) {
          var o = 'i-expanded',
            i = t.hasClass(o);
          t.toggleClass(o, !i), this._nodeExpandCollapseCallback && this._nodeExpandCollapseCallback(t, e, !i);
        }),
        (t.exports.ObjectTreeItemsController = r);
    }.call(e, o(5), o(41)));
  },
  1290: function(t, e) {},
  1291: function(t, e) {
  ...
  1298: function(t, e, o) {
    ...
    function i(t, e, o, i, s) {
      r.call(this, t, e, o, i),
        ...
        (this._$totalValueContainer = $('<div>').appendTo(s));
    }
    var r = o(1247);
    o(1299),
      inherit(i, r),
      (i.prototype.destroy = function() {
        this._clearRemoveNodeTimer(), r.prototype.destroy.call(this);
      }),
      (i.prototype.initView = function() {
      ...
      (i.prototype._renderViewForSymbol = function(t, e, o) {
        ...
        if (t.next().hasClass(l)) return t.next().toggleClass('i-expanded', o), void this._scroll.updateScrollBar();
        for (i = $('<div class="i-expanded ' + l + '">'), r = this._symbolDrawingsMap[e], s = 0; s < r.length; ++s)
          (n = r[s]),
      ...
      (i.prototype._renderEmptyListMessageIfNeeded = function() {
        this._$emptyListMessage.toggleClass('js-hidden', 0 !== Object.keys(this._symbolDrawingsMap).length);
      }),
      (i.prototype._removeSourceFromView = function(t) {
        var e,
          o,
          i,
          r = this._getItemForSourceId(t.id());
        if (0 === r.length) return void this._renderView(null);
        t.id() === this._selectedSourceId() && this._listAccessor().activateItem(null, null),
          ...
          0 === this._symbolDrawingsMap[i].length
            ? (e.remove(), o.remove(), delete this._symbolDrawingsMap[i], this._renderEmptyListMessageIfNeeded())
            : (r.remove(),
