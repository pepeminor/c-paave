        ...
        if (((this._options = e(r, t)), t.preset)) {
          ...
          o
            ? (void 0 !== this._options.disabled_features
                ? (this._options.disabled_features = this._options.disabled_features.concat(o.disabled_features))
                : (this._options.disabled_features = o.disabled_features),
              void 0 !== this._options.enabled_features
                ? (this._options.enabled_features = this._options.enabled_features.concat(o.enabled_features))
      ...
      return (
        ...
        (t.prototype._render = function() {
          ...
          var e =
            ...
            '-tv-chart.1c7535a2aac5ec511ed5.html#symbol=' +
