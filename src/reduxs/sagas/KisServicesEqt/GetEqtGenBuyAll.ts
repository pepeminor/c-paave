...
import { SERVICE_GET_EQUITY_GEN_BUY_ALL } from 'reduxs/actions';
...
export default function* watchOnGetEquityGenBuyAll() {
  yield takeEvery(SERVICE_GET_EQUITY_GEN_BUY_ALL, sagaHandling);
}
