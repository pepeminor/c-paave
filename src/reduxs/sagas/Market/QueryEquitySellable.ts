import { ORDER_QUERY_EQUITY_SELLABLE_INFO } from './../../actions';
...
export default function* watchQueryEquitySellable() {
  yield takeLeading(ORDER_QUERY_EQUITY_SELLABLE_INFO, queryEquitySellable);
}
