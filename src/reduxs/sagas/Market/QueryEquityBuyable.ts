import { ORDER_QUERY_EQUITY_BUYABLE_INFO } from './../../actions';
...
export default function* watchQueryEquityBuyable() {
  yield takeLeading(ORDER_QUERY_EQUITY_BUYABLE_INFO, queryEquityBuyable);
}
